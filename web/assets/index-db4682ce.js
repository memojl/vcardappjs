import{getAuth as Cr,GoogleAuthProvider as Rr,signInWithPopup as qr,signOut as $r,onAuthStateChanged as Er}from"https://www.gstatic.com/firebasejs/10.4.0/firebase-auth.js";import{initializeApp as Dr}from"https://www.gstatic.com/firebasejs/10.4.0/firebase-app.js";import{getFirestore as _r}from"https://www.gstatic.com/firebasejs/10.4.0/firebase-firestore.js";import{getDatabase as Or,set as Nr,ref as hr,onValue as Mr}from"https://www.gstatic.com/firebasejs/10.4.0/firebase-database.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(e){if(e.ep)return;e.ep=!0;const i=s(e);fetch(e.href,i)}})();let Br=window.location;const{pathname:Hr,host:W}=Br;W!=="localhost"&&W!=="localhost:5173"&&W!=="127.0.0.1:5173"&&"serviceWorker"in navigator&&navigator.serviceWorker.register(Hr+"sw.js").then(function(n){console.log("Service Worker registro correcto con scope: ",n.scope)}).catch(function(n){console.log("Service Worker registro fallo: ",n)});const{host:dr}=window.location,Vr="Vcard",Fr="firebase",_="#/",yr="src/",J=yr+"pages/",Gr="vite",X="localhost:5173",rr="localhost",Ur="https://vcardapp-js.firebaseio.com",I=Ur,Wr=I+"/v2/api_version";console.log(dr+"=="+X,dr+"=="+rr);console.warn("Api="+I);const Jr=`<div class="container text-center">\r
    <div class="row">\r
...
\r
    ...
    <h1>Nosotros</h1>\r
</div>`,dn=`<div class="container text-center">\r
    <h1>Productos</h1>\r
</div>`,cn="<h1>Categorias</h1>",pn=`<div class="container text-center">\r
    <h1>Contacto</h1>\r
</div>\r
`,O=`<nav id="menuweb" class="navbar navbar-expand-lg navbar-dark bg-dark">\r
...
</nav>`,vn=["dashboard","settings","perfil","tarjetas","empresas"],mn={forget:Jr,login:zr,logout:Yr,noauth:Kr,registro:Qr,dashboard:Zr,settings:Xr,perfil:rn,tarjetas:nn,empresas:an},kr={Home:en,app:sn,vcard:on,profile:tn,nosotros:O+ln,productos:O+dn,categorias:O+cn,contacto:O+pn},wr={...kr,...mn},cr=[{txt:"Dashboard",icon:"icon-dashboard",link:"/#/app"},{txt:"Dashboard",icon:"icon-dashboard",link:"/#/dashboard"},{txt:"Perfil",icon:"fa fa-user",link:"/#/app/perfil"},{txt:"Mis tarjetas",icon:"fa fa-vcard",link:"/#/app/tarjetas"},{txt:"Mis empresas",icon:"fa fa-industry",link:"/#/app/empresas"}],un=`<div class="text-center">\r
...
`,gn=n=>{var r=wr[n];return r=r??un,jn(r)},pr=async n=>{try{const r=await fetch(n);if(r.status==200){const s=await r.json();if(s)return s}else console.log("Error 404")}catch(r){console.log(r)}},{hash:la,host:fn,year:bn,hostDev:hn,typeBack:xr,apiVer:yn}=f();function kn(){var n=self.location.href,r=n.lastIndexOf("/"),s=n.substring(r+1,n.length);return s}function wn(n,r){var s=n.replace("/"+r,""),a=s.split("/"),e=window.location.search.substring(1),i=e.split("&");return e==""&&(i=["mod="+a[1],"ext="+a[2],"id="+a[3]]),i}function xn(n){for(var r=0;r<n.length;r++){var s=n[r].split("=");if(s[0]=="mod")var a=s[1];if(s[0]=="ext")var e=s[1];if(s[0]=="id")var i=s[1]}return a=a==""?"Home":a.replace("?",""),e=e==""||e=="undefined"?"index":e,i=i==""||i=="undefined"?"":i,{mod:a,ext:e,id:i}}function In(n,r,s,a){let e=localStorage.getItem("Token");document.querySelector("#menuweb");let i=document.querySelector(".user-login"),o=document.querySelector(".user-activo"),l=document.querySelector(".user-logout");s[r]&&(i.classList.remove("d-none"),o.classList.add("d-none"),l.classList.add("d-none"),e!=null&&e!=null&&e!="null"&&e!="undefined"&&(i.classList.add("d-none"),o.classList.remove("d-none"),l.classList.remove("d-none")))}const Ln=(n,r,s,a,e)=>{localStorage.getItem("Token"),p("log","hash=>"+n);let i=r=="vcard"?"":z(r),o=s!="index"?""+z(s):"",l=a!=""?" / "+z(a):"";document.title=e+" - "+i+o+l,Sn(r,vn);let c=r!="Home"&&s!="index"?s:r,t=document.getElementById("app");if(t&&(t.innerHTML="",n))return t.appendChild(gn(c))};function Sn(n,r){var s=localStorage.getItem("Token");p("log","token="+s);let a=r.length;for(let e=0;e<a;e++)n===r[e]&&p("log","Accceso: "+n+"="+r[e]),n===r[e]&&(s==null||s=="undefined")&&(window.location.href="#/noauth");n=="login"&&s!=null&&s!="undefined"&&(window.location.href="#/dashboard")}function jn(n){const r=document.createElement("div");return r.innerHTML=n,r}function Tn(n,r){(n==""||n=="undefined")&&(window.location.href=r)}function p(n,r){if(fn==hn)switch(n){case"log":console.log(r);break;case"warn":console.warn(r);break;case"error":console.error(r);break;default:console.log(r);break}}function z(n){return n[0].toUpperCase()+n.slice(1).toLowerCase()}function Y(n,r){if(n.length>0)for(let e=0;e<n.length;e++)if(console.log("load",r+e),document.getElementById(r+e))console.log("Reload Ok: "+r+e);else if(console.log(r+e,n[e]),document.createStyleSheet)document.createStyleSheet(n[e]);else{var s="@import url('"+n[e]+"');",a=document.createElement("link");a.id=r+e,a.rel="stylesheet",a.href="data:text/css,"+escape(s),document.getElementsByTagName("head")[0].appendChild(a)}}function K(n,r){for(let s=0;s<n.length;s++){console.log("delete",r+s);let a=document.getElementById(r+s);a&&document.getElementsByTagName("head")[0].removeChild(a)}}function vr(n,r,s){if(n.length>0)for(let e=0;e<n.length;e++){console.log("load",r+e);let i=document.getElementById(r+e);if(i&&document.body.removeChild(i),s=="load")if(document.getElementById(r+e))console.log("Reload Ok: "+r+e);else{console.log(r+e,n[e]);var a=document.createElement("script");a.id=r+e,a.src=n[e],document.body.appendChild(a)}}}function mr(n,r){if(n.length>0)for(let a=0;a<n.length;a++)if(console.log("load",r+a),document.getElementById(r+a))console.log("Reload Ok: "+r+a);else{console.log(r+a,n[a]);var s=document.createElement("script");s.id=r+a,s.src=n[a],document.body.appendChild(s)}}function ur(n,r){for(let s=0;s<n.length;s++){console.log("delete",r+s);let a=document.getElementById(r+s);a&&document.body.removeChild(a)}}function An(){const n=document.querySelector("#footer_page");n.innerHTML=bn+' &copy; VcardAppJS V.3.0.1 (Vite - MandragoraJS). Diseñada por <a target="_blank" href="http://multiportal.com.mx">[:MULTIPORTAL:]</a>.'}function Pn(){let n=document.getElementsByTagName("body")[0],s=`<div class="layerLoading">
    <img src="./assets/img/loader-green.gif" alt=""/>
    <p>Cargando...</p>
  </div>`;var a=document.createElement("div");a.id="load",a.innerHTML=s,n.appendChild(a),setTimeout(()=>{let e=document.getElementById(a.id);e&&n.removeChild(e)},5e3)}function Cn(){const{mod:n,ext:r}=f();let s=n!="Home"&&r!="index"?r:n;var a=wr[s];n!="dashboard"&&xr=="firebase"&&n!="logout"&&n!="noauth"&&r=="index"&&a!=null&&Pn()}async function Rn(n,r){if(xr!="firebase"){if(n=="Home"){const{version:s}=await pr(`${r}assets/pwa/manifest.json`);console.log(`Version Actual: ${s}`);const a=await pr(yn);if(a&&a!=null){const{ultimate:e}=a.data[0];s!=e&&console.log(`Actualizar version ${n} (${s} => ${e})`)}else console.warn("No se pudo llevar a cabo la comprobación de versiones")}}else console.warn("Only Firebase")}function qn(n,r,s){setTimeout(()=>{const a=document.querySelector("#menuList");let e="";if(a){for(let i=0;i<cr.length;i++){const{txt:o,icon:l,link:c}=cr[i];if((s=="app"||s=="dashboard")&&c!="/#/app"){const t=c=="/"+n||o=="Dashboard"&&r=="app/index"?'class="active"':"";e+=`<li ${t}><a href="${c}"><i class="${l}"></i> ${o}</a></li>`}}a.innerHTML=e}},100)}const $n=f(),{host:En,dominio:Dn,path_url:_n,hostDev:On,typeBack:Nn}=$n;console.log("/* javascript login | VARIABLES CONSTANTES*/");let ar=I+"/login/";En==On&&Nn!="firebase"&&console.log("api_login="+ar);function Mn(){const n=document.getElementById("form-login");n!=null&&(n.addEventListener("submit",Bn),console.log("btnLogin Activado"))}function Bn(n){n.preventDefault(),console.log("Validación de Datos");let r=document.getElementById("username").value,s=document.getElementById("password").value;var a={username:r,password:s};const e=ar+"index.php";fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}).then(i=>i.json()).then(i=>{const{data:o}=i;p("log",i),p("log","getToken:"+o.token),localStorage.setItem("Token",o.token);let l=localStorage.getItem("Token");if(p("log","Res-Token:"+l),l!=null&&l!="undefined")location.href=Dn+_n+"#/dashboard";else{let c=document.getElementById("msj-error");c.innerHTML='<div class="alert alert-danger" role="alert">Usuario o Contraseña Incorrectos</div>'}}).catch(i=>{console.log(i);let o=document.getElementById("msj-error");o.innerHTML='<div class="alert alert-danger" role="alert">Error:Usuario o Contraseña Incorrectos</div>'})}const Hn=()=>{const n=ar+"";fetch(n).then(r=>r.json()).then(r=>{p("log",r)}).catch(r=>console.log(r)),setTimeout(function(){Mn()},1e3)};function Vn(){console.log("Logout/Salir"),localStorage.clear();var n=localStorage.getItem("Token");n==null&&(console.warn("TOKEN CLEAR"),setTimeout(function(){window.location.href="#/"},3e3))}f();function Fn(n){let r=document.querySelector(".body");r&&(n!=""&&n!="Home"?r.style.display="none":r.style.display="inherit")}function Gn(n,r){const s=["https://fonts.googleapis.com/css?family=Muli:300,400,700","https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css",r+"assets/login/vendor/bootstrap/css/bootstrap.min.css",r+"assets/login/vendor/font-awesome/css/font-awesome.min.css",r+"assets/login/css/font.css",r+"assets/login/css/style.green.css",r+"assets/login/css/custom.css"],a=[r+"assets/login/vendor/popper.js/umd/popper.min.js",r+"assets/login/vendor/bootstrap/js/bootstrap.min.js",r+"assets/login/vendor/bootstrap/js/bootstrap-colorpicker.min.js",r+"assets/login/vendor/jquery.cookie/jquery.cookie.js",r+"assets/login/vendor/chart.js/Chart.min.js",r+"assets/login/vendor/jquery-validation/jquery.validate.min.js","https://cdn.jsdelivr.net/npm/sweetalert2@9.14.4/dist/sweetalert2.all.min.js","https://cdn.jsdelivr.net/npm/toastify-js",r+"assets/login/js/front.js"];n=="app"||n=="dashboard"?(console.log("cssLoadMod-loadStyle",n),Y(s,"appCS-"),vr(a,"appJS-","load")):(console.log("cssLoadMod-delStyle",n),K(s,"appCS-"),vr(a,"appJS-","del"));const e=["https://fonts.googleapis.com/css?family=Playfair+Display:400,700%7CSintony:400,700",r+"assets/tema/css/bootstrap.min.css",r+"assets/tema/css/all.min.css",r+"assets/tema/css/animate.min.css",r+"assets/tema/css/simple-line-icons.min.css",r+"assets/tema/css/owl.carousel.min.css",r+"assets/tema/css/owl.theme.default.min.css",r+"assets/tema/css/magnific-popup.min.css",r+"assets/tema/css/theme.css",r+"assets/tema/css/theme-elements.css",r+"assets/tema/css/theme-blog.css",r+"assets/tema/css/theme-shop.css",r+"assets/tema/css/settings.css",r+"assets/tema/css/layers.css",r+"assets/tema/css/navigation.css",r+"assets/tema/css/demo-business-consulting.css",r+"assets/tema/css/skin-business-consulting.css",r+"assets/tema/css/style.css",r+"assets/font-awesome-4.7.0/css/font-awesome.css"],i=[r+"assets/tema/js/jquery.appear.min.js",r+"assets/tema/js/jquery.easing.min.js",r+"assets/tema/js/jquery.cookie.min.js",r+"assets/tema/js/popper.min.js",r+"assets/tema/js/bootstrap.min.js",r+"assets/tema/js/common.min.js",r+"assets/tema/js/jquery.validate.min.js",r+"assets/tema/js/jquery.easypiechart.min.js",r+"assets/tema/js/jquery.gmap.min.js",r+"assets/tema/js/jquery.lazyload.min.js",r+"assets/tema/js/jquery.isotope.min.js",r+"assets/tema/js/owl.carousel.min.js",r+"assets/tema/js/jquery.magnific-popup.min.js",r+"assets/tema/js/jquery.vide.min.js",r+"assets/tema/js/vivus.min.js",r+"assets/tema/js/theme.js",r+"assets/tema/js/jquery.themepunch.tools.min.js",r+"assets/tema/js/jquery.themepunch.revolution.min.js",r+"assets/tema/js/demo-business-consulting.js",r+"assets/tema/js/custom.js",r+"assets/tema/js/theme.init.js"];n!="Home"?(K(e,"homeCS-"),ur(i,"homeJS-")):(Y(e,"homeCS-"),mr(i,"homeJS-"));const o=["https://fonts.googleapis.com/css?family=Open+Sans:400italic,400,700,300&amp;lang=es",r+"assets/font-awesome-4.7.0/css/font-awesome.css",r+"assets/vcard/css/style2.css",r+"assets/vcard/css/examples.css",r+"assets/vcard/css/webhost.css"],l=["https://maps.google.com/maps/api/js?key=AIzaSyBiB2Ny_sdk1kyc8tVK64NfxQ1b0yQoaWw",r+"assets/vcard/js/gmaps.js"];n!="vcard"?(K(o,"vcardCS-"),ur(l,"vcardJS-")):(Y(o,"vcardCS-"),mr(l,"vcardJS-"))}console.log("Firebase SDK");var Un={apiKey:"AIzaSyDeX81H_K8AsV2KjQgEbwxte6yVdSYqFXk",authDomain:"vcardapp-js.firebaseapp.com",databaseURL:"https://vcardapp-js.firebaseio.com",projectId:"vcardapp-js",storageBucket:"vcardapp-js.appspot.com",messagingSenderId:"420720513571",appId:"1:420720513571:web:f072eeda6cd3cfa1429796",measurementId:"G-LDPZ4BZ1GV"};const er=Dr(Un),sr=Cr(er),Ir=Or(er);_r(er);function Wn(n){console.log("saveUser");var r={uid:n.uid,usuario:n.displayName,email:n.email,foto:n.photoURL};Nr(hr(Ir,"vcard_signup/"+n.uid),r)}function Jn(n){const r=document.querySelector("#photo"),s=document.querySelector("#nombre_session"),a=document.querySelector("#email_session"),e=document.querySelector("#id_code_google"),i=hr(Ir,"vcard_signup/");Mr(i,o=>{const l=o.val();for(let c in l){const t=l[c];if(t.uid==n.uid){console.log(t);const v='<img src="'+(t.foto==null?page_url+"assets/img/sinfoto.png":t.foto)+'" class="img-fluid rounded-circle">',d=t.usuario==null?t.email:t.usuario,L=t.email,b=t.uid;r.innerHTML=v,s.innerHTML=d,a.innerHTML=L,e.innerHTML=b}}})}document.querySelectorAll(".logged-out");document.querySelectorAll(".logged-in");const gr=n=>{console.log("loginCheck"),document.querySelector("#logout-1");const r=document.querySelector("#btnRegis"),s=document.querySelector("#btnLogin"),a=document.querySelector(".registro-page"),e=document.querySelector(".login-page"),i=document.querySelector(".dashboard");n?(e.style.display="none",a.style.display="none",i.style.display="block"):(e.style.display="block",i.style.display="none",r&&r.addEventListener("click",()=>{a.style.display="block",e.style.display="none"}),s&&s.addEventListener("click",()=>{a.style.display="none",e.style.display="block"}))};function Lr(n,r){Toastify({text:n,duration:3e3,destination:"https://github.com/apvarun/toastify-js",newWindow:!0,close:!0,gravity:"bottom",position:"right",stopOnFocus:!0,style:{background:r==="success"?"green":r==="warning"?"orange":r==="info"?"blue":"red"},onClick:function(){}}).showToast()}function zn(){const n=document.querySelector("#googleLogin");n&&n.addEventListener("click",async r=>{r.preventDefault();const s=new Rr;try{const a=await qr(sr,s);console.log(a),console.log("google sign in"),localStorage.setItem("Token",a.user.accessToken);let e=localStorage.getItem("Token");consoleLocal("log","Res-Token:"+e),Lr("Welcome "+a.user.displayName,"success")}catch(a){console.log(a)}})}function Yn(){const n=document.querySelector("#logout");n&&n.addEventListener("click",async r=>{r.preventDefault();try{await $r(sr),console.log("Logout/Salir"),localStorage.clear();var s=localStorage.getItem("Token");s==null&&console.warn("TOKEN CLEAR"),Lr("Signup out","info")}catch(a){console.log(a)}})}function Kn(){console.log("Cargando App..."),zn(),Yn(),Er(sr,async n=>{if(n){gr(n),Jn(n);try{Wn(n)}catch(r){console.log(r)}}else gr(n)}),An()}const x=()=>{Kn()};async function fr(n,r){const a=await(await fetch(r)).json();let e=null;for(const i in a)(a[i].profile===n||a[i].ID===n)&&(e=a[i]);return e}function nr(n){n!="inicio"?$("#close").show():$("#close").hide(),n=="inicio"?$("#inicio").fadeIn():$("#inicio").hide(),n=="contacto"?$("#contacto").fadeIn():$("#contacto").hide(),n=="ubicacion"?$("#ubicacion").fadeIn():$("#ubicacion").hide(),n=="compartir"?$("#compartir").fadeIn():$("#compartir").hide(),n=="guardar"?$("#guardar").fadeIn():$("#guardar").hide(),n=="acceso"?$("#acceso").fadeIn():$("#acceso").hide()}function Qn(n){if(n=="viewcopy"){$("#inputCopiar").select();var r=document.execCommand("copy");r?(console.log("Texto Copiado"),document.getElementById("aviso").innerHTML='<div class="alert alert-success">Texto Copiado!</div>'):console.log("> No copy to clipboard")}}function Zn(){const n=document.querySelector("#footerbar");n&&n.addEventListener("click",r=>{const s=r.target.id.replace("btn","").replace("1","").toLowerCase();s&&s!=""&&nr(s)})}function Xn(n,r,s){var a=new Image;a.src=n,a.addEventListener("load",()=>{const e=s==0?"Logo":"Foto de perfil";console.log("Success: "+e),s==0?r.src=n:r.style.backgroundImage=`url('${n}')`}),a.addEventListener("error",()=>{const e=s==0?"logo":"foto de perfil";console.error("Error: Fallo carga de "+e)})}function br(n,r,s,a){var e=new Image;e.src=n,e.addEventListener("load",()=>{const i=a==0?"Logo":"Foto de perfil";console.log("Success: "+i),a==0?s.src=n:s.style.backgroundImage=`url('${n}')`}),e.addEventListener("error",()=>{const i=a==0?"logo":"foto de perfil";r&&r!=""?Xn(r,s,a):console.error("Error: Fallo carga de "+i)})}const{host:da,dominio:ca,mod:pa,ext:va,id:Q,URL:Z}=f();async function ra(){const n=encodeURIComponent(Z);console.log(n);const r=await fr(Q,I+"/vcard_vcard.json");if(console.log("Usuario",r),r==null){document.querySelector("#container").style.display="none";return}const{nombre:s,profile:a,puesto:e,descripcion:i,fb:o,tw:l,ins:c,lk:t,web:m,email:v,cell:d,tel_ofi:L,cover:b,idemp:h,visible:ir,direc:S}=r,y=await fr(h,I+"/vcard_vcard_empresas.json");console.log("Empresa",y);const{bg_color:k,coverbg:j,empresa:T}=y;nr("inicio"),Zn(),document.querySelector("#head").style.backgroundColor=k;const N=Q=="multiportal"?"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpprRNyywxrgFdZ7rLvnq-6jEgWCBq_4Js3A&s":null;br(y.cover,N,document.querySelector("#logo"),0);const M=Q=="multiportal"?"https://multiportal.webcindario.com/assets/img/Multiportal.logo2023.png":null;br(b,M,document.querySelector("#fotoperfil"),1),document.querySelector("#tit").innerHTML=s,document.querySelector("#puesto").innerHTML=e,document.querySelector("#des").innerHTML=i;const B=document.querySelector("#medios"),H=d?`<a href="tel:${d}"><i class="fa fa-phone"></i><span>Llamar</span></a>`:"",A=d?`<a target="_blank" href="https://wa.me/+52${d}"><i class="fa fa-whatsapp"></i><span>WhatsApp</span></a>`:"",V=v?`<a href="mailto:${v}"><i class="fa fa-envelope-o"></i><span>E-mail</span></a>`:"",F=m?`<a href="${m}" target="_blank" id="empresaweb">${T}</a>`:"";B.innerHTML=H+A+V+F;const P=document.querySelector("#redes"),g=o?`
  ...
  <a href="${c}" target="_blank" aria-label="Instagram" class="icon-rrss">
    ...
    <span>Instagram</span>
  </a>`:"";P.innerHTML=`<div id="medios">${g} ${u} ${G} ${C}</div>`;const w=document.querySelector("#a-cell");d?w.setAttribute("href","tel:"+d):w.style.display="none";const R=document.querySelector("#a-wa");d?R.setAttribute("href","https://wa.me/+52"+d):R.style.display="none";const q=document.querySelector("#a-sms");d?q.setAttribute("href","sms:"+d):q.style.display="none";const E=document.querySelector("#a-email");v?E.setAttribute("href","mailto:"+v):E.style.display="none";const D=document.querySelector("#a-web");m?D.setAttribute("href",m):D.style.display="none";const U=document.querySelector("#ubi");U.innerHTML=S?`<p style="font-size: 18px;"><b>Dirección:</b> ${S}</p>
  <div id="map"></div>`:"<p>No hay dirección disponible.</p>";const or=document.querySelector(".share"),jr=`
  ...
  <a target="_blank" href="https://api.whatsapp.com/send?text=Accede+a+la+tarjeta+digital+desde+el+siguiente+enlace:+${n}" aria-label="whatsapp" class="icon-access">
    ...
    <span>WhatsApp</span>
  </a>`;or.innerHTML=`${jr}${Tr}${Ar}${Pr}`,document.querySelector("#inputCopiar").value=Z;const tr=document.querySelector("#viewcopy");tr&&tr.addEventListener("click",()=>{Qn("viewcopy")}),document.querySelector("#sendEmail").href="mailto:?body="+Z,document.querySelector("#saveCard").href=`files/vcf/${a}.vcf`;const lr=document.querySelector("#close");lr&&lr.addEventListener("click",()=>{nr("inicio")})}function na(){setTimeout(()=>{ra()},500)}function aa(n){const{route:r,hash:s,mod:a,ext:e,id:i,base_url:o}=n;p("log","route="+r),Cn(),a&&(Fn(a),Gn(a,o)),r=="dashboard/index"&&x(),r=="app/index"&&x(),r=="app/perfil"&&x(),r=="app/tarjetas"&&x(),r=="app/empresas"&&x(),(r=="vcard/index"||r=="vcard/profile")&&na(),r=="login/index"&&Hn(),r=="logout/index"&&Vn(),(a=="app"||a=="dashboard")&&qn(s,r,a)}function f(){var n=window,r=document,s=n.location,a=new Date,e=a.getDate();e=e<10?"0"+e:e;var i=a.getMonth()+1;i=i<10?"0"+i:i;var o=a.getFullYear(),l=o+"-"+i+"-"+e;const{protocol:c,host:t,origin:m,pathname:v,hash:d,href:L,search:b}=s,h=m+"/",ir=m,S=L,y=b,k=v.replace("/",""),j=h+k,T=t=="localhost"||t!=X&&t!=rr?k+_:_,N=t=="localhost:9001"?"../":"./",M=h+T,B=screen.width,H=screen.height;var A="default",V="temas/"+A+"/",F=kn(),P=wn(d,_);let{mod:g,ext:u,id:G}=xn(P);var C="/"+u,w=g+C,R=g||"",q=u&&u!="index"?"/"+u:"",E="#/"+R+q,D=j+J+w+".html",U=j+J+"404/index.html";return{w:n,d:r,loc:s,dt:a,day:e,mon:i,year:o,fecha:l,title:Vr,typeBack:Fr,typeDev:Gr,path_hash:_,path_src:yr,path_page:J,hostDev:X,hostPre:rr,protocol:c,host:t,dominio:h,dominio1:ir,pathname:v,hash:d,URL:S,quest:y,path_url:k,path_root:T,path_build:N,base_url:j,page_url:M,screenw:B,screenh:H,tema:A,path_tema:V,pag_name:F,vars_Url:P,mod:g,ext:u,id:G,ext2:C,route:w,hash2:E,url_mod:D,url404:U,apiVer:Wr}}function Sr(){const n=f();p("log",n);const{hash:r,mod:s,ext:a,id:e,page_url:i,base_url:o,title:l}=n;Ln(r,s,a,e,l),aa(n),In(r,s,kr),Tn(s,i),Rn(s,o)}function ea(){console.log("Run function inicio"),Sr()}window.addEventListener("hashchange",()=>{p("warn","Event Listener"),Sr()});ea();
