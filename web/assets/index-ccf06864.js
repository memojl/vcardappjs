        ...
        <div id="slimscroll-menu" class="slimscroll-menu">\r
            ...
            <div class="user-box">\r
                <div class="user-img">\r
                    ...
                    <a href="javascript:void(0);" class="user-edit" data-menu="cuenta"><i class="mdi mdi-pencil"></i></a>\r
                </div>\r
        \r
...
\r
            ...
            <hr class="mt-0" />\r
            <div class="row">\r
                <div class="col-6 text-center btn-set hand" data-menu="settings">\r
...
\r
            ...
            <!-- Left Sidebar End -->`,Z=`          <!-- Topbar Start -->\r
...
</div>`,ie={Home:Oe},Ue={dashboard:'<!-- Begin page --><div id="wrapper">'+Z+Y+'<div class="content-page">'+Ce+ee+"</div></div><!-- END wrapper -->"+X,app:'<!-- Begin page --><div id="wrapper" class="dashboard" style="display: none;">'+Z+Y+'<div class="content-page">'+Ie+ee+"</div></div><!-- END wrapper -->"+X+_e+Le,dash:Ae,tarjetas:Be,empresas:Me,cuenta:Re,settings:Ee,forget:qe,login:De,logout:je,registro:Pe,noauth:Te},le={...ie,...Ue},He=["dashboard","tarjetas","empresas","cuenta","settings"],te={dash:{txt:"Dashboard",icon:"fas fa-tachometer-alt"},tarjetas:{txt:"Mis tarjetas",icon:"far fa-address-card"},empresas:{txt:"Mis empresas",icon:"fas fa-industry"}},Fe=`<div class="text-center">\r
