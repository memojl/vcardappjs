...
`,B=`<nav id="menuweb" class="navbar navbar-expand-lg navbar-dark bg-dark">\r
...
`,gn=n=>{var r=Ir[n];return r=r??un,Ln(r)},vr=async n=>{try{const r=await fetch(n);if(r.status==200){const s=await r.json();if(s)return s}else console.log("Error 404")}catch(r){console.log(r)}},{hash:oa,host:p,year:fn,hostDev:m,typeBack:Lr,apiVer:bn}=y();function hn(){var n=self.location.href,r=n.lastIndexOf("/"),s=n.substring(r+1,n.length);return s}function yn(n,r){var s=n.replace("/"+r,""),a=s.split("/"),e=window.location.search.substring(1),i=e.split("&");return e==""&&(i=["mod="+a[1],"ext="+a[2],"id="+a[3]]),i}function kn(n){for(var r=0;r<n.length;r++){var s=n[r].split("=");if(s[0]=="mod")var a=s[1];if(s[0]=="ext")var e=s[1];if(s[0]=="id")var i=s[1]}return a=a==""?"Home":a.replace("?",""),e=e==""||e=="undefined"?"index":e,i=i==""||i=="undefined"?"":i,{mod:a,ext:e,id:i}}function wn(n,r,s,a){let e=localStorage.getItem("Token");document.querySelector("#menuweb");let i=document.querySelector(".user-login"),o=document.querySelector(".user-activo"),l=document.querySelector(".user-logout");s[r]&&(i.classList.remove("d-none"),o.classList.add("d-none"),l.classList.add("d-none"),e!=null&&e!=null&&e!="null"&&e!="undefined"&&(i.classList.add("d-none"),o.classList.remove("d-none"),l.classList.remove("d-none")))}const xn=(n,r,s,a,e)=>{localStorage.getItem("Token"),u("log","hash=>"+n);let i=r=="vcard"?"":K(r),o=s!="index"?""+K(s):"",l=a!=""?" / "+K(a):"";document.title=e+" - "+i+o+l,In(r,mn);let c=r!="Home"&&s!="index"?s:r,t=document.getElementById("app");if(t&&(t.innerHTML="",n))return t.appendChild(gn(c))};function In(n,r){var s=localStorage.getItem("Token");u("log","token="+s);let a=r.length;for(let e=0;e<a;e++)n===r[e]&&u("log","Accceso: "+n+"="+r[e]),n===r[e]&&(s==null||s=="undefined")&&(window.location.href="#/noauth");n=="login"&&s!=null&&s!="undefined"&&(window.location.href="#/dashboard")}function Ln(n){const r=document.createElement("div");return r.innerHTML=n,r}function Sn(n,r){(n==""||n=="undefined")&&(window.location.href=r)}function u(n,r){if(p==m)switch(n){case"log":console.log(r);break;case"warn":console.warn(r);break;case"error":console.error(r);break;default:console.log(r);break}}function K(n){return n[0].toUpperCase()+n.slice(1).toLowerCase()}function Q(n,r){if(n.length>0)for(let e=0;e<n.length;e++)if(p==m&&v&&console.log("load",r+e),document.getElementById(r+e))p==m&&v&&console.log("Reload Ok: "+r+e);else if(p==m&&v&&console.log(r+e,n[e]),document.createStyleSheet)document.createStyleSheet(n[e]);else{var s="@import url('"+n[e]+"');",a=document.createElement("link");a.id=r+e,a.rel="stylesheet",a.href="data:text/css,"+escape(s),document.getElementsByTagName("head")[0].appendChild(a)}}function Z(n,r){for(let s=0;s<n.length;s++){p==m&&v&&console.log("delete",r+s);let a=document.getElementById(r+s);a&&document.getElementsByTagName("head")[0].removeChild(a)}}function ur(n,r,s){if(n.length>0)for(let e=0;e<n.length;e++){p==m&&v&&console.log("load",r+e);let i=document.getElementById(r+e);if(i&&document.body.removeChild(i),s=="load")if(document.getElementById(r+e))p==m&&v&&console.log("Reload Ok: "+r+e);else{p==m&&v&&console.log(r+e,n[e]);var a=document.createElement("script");a.id=r+e,a.src=n[e],document.body.appendChild(a)}}}function gr(n,r){if(n.length>0)for(let a=0;a<n.length;a++)if(p==m&&v&&console.log("load",r+a),document.getElementById(r+a))p==m&&v&&console.log("Reload Ok: "+r+a);else{p==m&&v&&console.log(r+a,n[a]);var s=document.createElement("script");s.id=r+a,s.src=n[a],document.body.appendChild(s)}}function fr(n,r){for(let s=0;s<n.length;s++){p==m&&v&&console.log("delete",r+s);let a=document.getElementById(r+s);a&&document.body.removeChild(a)}}function jn(){const n=document.querySelector("#footer_page");n.innerHTML=fn+' &copy; VcardAppJS V.3.0.1 (Vite - MandragoraJS). Diseñada por <a target="_blank" href="http://multiportal.com.mx">[:MULTIPORTAL:]</a>.'}function Tn(){let n=document.getElementsByTagName("body")[0],s=`<div class="layerLoading">
    <img src="./assets/img/loader-green.gif" alt=""/>
    <p>Cargando...</p>
  </div>`;var a=document.createElement("div");a.id="load",a.innerHTML=s,n.appendChild(a),setTimeout(()=>{let e=document.getElementById(a.id);e&&n.removeChild(e)},5e3)}function An(){const{mod:n,ext:r}=y();let s=n!="Home"&&r!="index"?r:n;var a=Ir[s];n!="dashboard"&&Lr=="firebase"&&n!="logout"&&n!="noauth"&&r=="index"&&a!=null&&Tn()}async function Pn(n,r){if(Lr!="firebase"){if(n=="Home"){const{version:s}=await vr(`${r}assets/pwa/manifest.json`);console.log(`Version Actual: ${s}`);const a=await vr(bn);if(a&&a!=null){const{ultimate:e}=a.data[0];s!=e&&console.log(`Actualizar version ${n} (${s} => ${e})`)}else console.warn("No se pudo llevar a cabo la comprobación de versiones")}}else console.warn("Only Firebase")}function Cn(n,r,s){setTimeout(()=>{const a=document.querySelector("#menuList");let e="";if(a){for(let i=0;i<mr.length;i++){const{txt:o,icon:l,link:c}=mr[i];if((s=="app"||s=="dashboard")&&c!="/#/app"){const t=c=="/"+n||o=="Dashboard"&&r=="app/index"?'class="active"':"";e+=`<li ${t}><a href="${c}"><i class="${l}"></i> ${o}</a></li>`}}a.innerHTML=e}},100)}const Rn=y(),{host:qn,dominio:En,path_url:$n,hostDev:Dn,typeBack:_n}=Rn;console.log("/* javascript login | VARIABLES CONSTANTES*/");let sr=j+"/login/";qn==Dn&&_n!="firebase"&&console.log("api_login="+sr);function On(){const n=document.getElementById("form-login");n!=null&&(n.addEventListener("submit",Nn),console.log("btnLogin Activado"))}function Nn(n){n.preventDefault(),console.log("Validación de Datos");let r=document.getElementById("username").value,s=document.getElementById("password").value;var a={username:r,password:s};const e=sr+"index.php";fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}).then(i=>i.json()).then(i=>{const{data:o}=i;u("log",i),u("log","getToken:"+o.token),localStorage.setItem("Token",o.token);let l=localStorage.getItem("Token");if(u("log","Res-Token:"+l),l!=null&&l!="undefined")location.href=En+$n+"#/dashboard";else{let c=document.getElementById("msj-error");c.innerHTML='<div class="alert alert-danger" role="alert">Usuario o Contraseña Incorrectos</div>'}}).catch(i=>{console.log(i);let o=document.getElementById("msj-error");o.innerHTML='<div class="alert alert-danger" role="alert">Error:Usuario o Contraseña Incorrectos</div>'})}const Mn=()=>{const n=sr+"";fetch(n).then(r=>r.json()).then(r=>{u("log",r)}).catch(r=>console.log(r)),setTimeout(function(){On()},1e3)};function Bn(){console.log("Logout/Salir"),localStorage.clear();var n=localStorage.getItem("Token");n==null&&(console.warn("TOKEN CLEAR"),setTimeout(function(){window.location.href="#/"},3e3))}y();function Hn(n){let r=document.querySelector(".body");r&&(n!=""&&n!="Home"?r.style.display="none":r.style.display="inherit")}function Vn(n,r){const s=["https://fonts.googleapis.com/css?family=Muli:300,400,700","https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css",r+"assets/login/vendor/bootstrap/css/bootstrap.min.css",r+"assets/login/vendor/font-awesome/css/font-awesome.min.css",r+"assets/login/css/font.css",r+"assets/login/css/style.green.css",r+"assets/login/css/custom.css"],a=[r+"assets/login/vendor/popper.js/umd/popper.min.js",r+"assets/login/vendor/bootstrap/js/bootstrap.min.js",r+"assets/login/vendor/bootstrap/js/bootstrap-colorpicker.min.js",r+"assets/login/vendor/jquery.cookie/jquery.cookie.js",r+"assets/login/vendor/chart.js/Chart.min.js",r+"assets/login/vendor/jquery-validation/jquery.validate.min.js","https://cdn.jsdelivr.net/npm/sweetalert2@9.14.4/dist/sweetalert2.all.min.js","https://cdn.jsdelivr.net/npm/toastify-js",r+"assets/login/js/front.js"];n=="app"||n=="dashboard"?(console.log("cssLoadMod-loadStyle",n),Q(s,"appCS-"),ur(a,"appJS-","load")):(console.log("cssLoadMod-delStyle",n),Z(s,"appCS-"),ur(a,"appJS-","del"));const e=["https://fonts.googleapis.com/css?family=Playfair+Display:400,700%7CSintony:400,700",r+"assets/tema/css/bootstrap.min.css",r+"assets/tema/css/all.min.css",r+"assets/tema/css/animate.min.css",r+"assets/tema/css/simple-line-icons.min.css",r+"assets/tema/css/owl.carousel.min.css",r+"assets/tema/css/owl.theme.default.min.css",r+"assets/tema/css/magnific-popup.min.css",r+"assets/tema/css/theme.css",r+"assets/tema/css/theme-elements.css",r+"assets/tema/css/theme-blog.css",r+"assets/tema/css/theme-shop.css",r+"assets/tema/css/settings.css",r+"assets/tema/css/layers.css",r+"assets/tema/css/navigation.css",r+"assets/tema/css/demo-business-consulting.css",r+"assets/tema/css/skin-business-consulting.css",r+"assets/tema/css/style.css",r+"assets/font-awesome-4.7.0/css/font-awesome.css"],i=[r+"assets/tema/js/jquery.appear.min.js",r+"assets/tema/js/jquery.easing.min.js",r+"assets/tema/js/jquery.cookie.min.js",r+"assets/tema/js/popper.min.js",r+"assets/tema/js/bootstrap.min.js",r+"assets/tema/js/common.min.js",r+"assets/tema/js/jquery.validate.min.js",r+"assets/tema/js/jquery.easypiechart.min.js",r+"assets/tema/js/jquery.gmap.min.js",r+"assets/tema/js/jquery.lazyload.min.js",r+"assets/tema/js/jquery.isotope.min.js",r+"assets/tema/js/owl.carousel.min.js",r+"assets/tema/js/jquery.magnific-popup.min.js",r+"assets/tema/js/jquery.vide.min.js",r+"assets/tema/js/vivus.min.js",r+"assets/tema/js/theme.js",r+"assets/tema/js/jquery.themepunch.tools.min.js",r+"assets/tema/js/jquery.themepunch.revolution.min.js",r+"assets/tema/js/demo-business-consulting.js",r+"assets/tema/js/custom.js",r+"assets/tema/js/theme.init.js"];n!="Home"?(Z(e,"homeCS-"),fr(i,"homeJS-")):(Q(e,"homeCS-"),gr(i,"homeJS-"));const o=["https://fonts.googleapis.com/css?family=Open+Sans:400italic,400,700,300&amp;lang=es",r+"assets/font-awesome-4.7.0/css/font-awesome.css",r+"assets/vcard/css/style2.css",r+"assets/vcard/css/examples.css",r+"assets/vcard/css/webhost.css"],l=["https://maps.google.com/maps/api/js?key=AIzaSyBiB2Ny_sdk1kyc8tVK64NfxQ1b0yQoaWw",r+"assets/vcard/js/gmaps.js"];n!="vcard"?(Z(o,"vcardCS-"),fr(l,"vcardJS-")):(Q(o,"vcardCS-"),gr(l,"vcardJS-"))}console.log("Firebase SDK");var Fn={apiKey:"AIzaSyDeX81H_K8AsV2KjQgEbwxte6yVdSYqFXk",authDomain:"vcardapp-js.firebaseapp.com",databaseURL:"https://vcardapp-js.firebaseio.com",projectId:"vcardapp-js",storageBucket:"vcardapp-js.appspot.com",messagingSenderId:"420720513571",appId:"1:420720513571:web:f072eeda6cd3cfa1429796",measurementId:"G-LDPZ4BZ1GV"};const ir=Or(Fn),or=qr(ir),Sr=Mr(ir);Nr(ir);function Gn(n){console.log("saveUser");var r={uid:n.uid,usuario:n.displayName,email:n.email,foto:n.photoURL};Br(kr(Sr,"vcard_signup/"+n.uid),r)}function Un(n){const r=document.querySelector("#photo"),s=document.querySelector("#nombre_session"),a=document.querySelector("#email_session"),e=document.querySelector("#id_code_google"),i=kr(Sr,"vcard_signup/");Hr(i,o=>{const l=o.val();for(let c in l){const t=l[c];if(t.uid==n.uid){console.log(t);const g='<img src="'+(t.foto==null?page_url+"assets/img/sinfoto.png":t.foto)+'" class="img-fluid rounded-circle">',d=t.usuario==null?t.email:t.usuario,T=t.email,k=t.uid;r.innerHTML=g,s.innerHTML=d,a.innerHTML=T,e.innerHTML=k}}})}document.querySelectorAll(".logged-out");document.querySelectorAll(".logged-in");const br=n=>{console.log("loginCheck"),document.querySelector("#logout-1");const r=document.querySelector("#btnRegis"),s=document.querySelector("#btnLogin"),a=document.querySelector(".registro-page"),e=document.querySelector(".login-page"),i=document.querySelector(".dashboard");n?(e.style.display="none",a.style.display="none",i.style.display="block"):(e.style.display="block",i.style.display="none",r&&r.addEventListener("click",()=>{a.style.display="block",e.style.display="none"}),s&&s.addEventListener("click",()=>{a.style.display="none",e.style.display="block"}))};function jr(n,r){Toastify({text:n,duration:3e3,destination:"https://github.com/apvarun/toastify-js",newWindow:!0,close:!0,gravity:"bottom",position:"right",stopOnFocus:!0,style:{background:r==="success"?"green":r==="warning"?"orange":r==="info"?"blue":"red"},onClick:function(){}}).showToast()}function Wn(){const n=document.querySelector("#googleLogin");n&&n.addEventListener("click",async r=>{r.preventDefault();const s=new Er;try{const a=await $r(or,s);console.log(a),console.log("google sign in"),localStorage.setItem("Token",a.user.accessToken);let e=localStorage.getItem("Token");consoleLocal("log","Res-Token:"+e),jr("Welcome "+a.user.displayName,"success")}catch(a){console.log(a)}})}function Jn(){const n=document.querySelector("#logout");n&&n.addEventListener("click",async r=>{r.preventDefault();try{await Dr(or),console.log("Logout/Salir"),localStorage.clear();var s=localStorage.getItem("Token");s==null&&console.warn("TOKEN CLEAR"),jr("Signup out","info")}catch(a){console.log(a)}})}function zn(){console.log("Cargando App..."),Wn(),Jn(),_r(or,async n=>{if(n){br(n),Un(n);try{Gn(n)}catch(r){console.log(r)}}else br(n)}),jn()}const S=()=>{zn()};async function hr(n,r){const a=await(await fetch(r)).json();let e=null;for(const i in a)(a[i].profile===n||a[i].ID===n)&&(e=a[i]);return e}function er(n){n!="inicio"?$("#close").show():$("#close").hide(),n=="inicio"?$("#inicio").fadeIn():$("#inicio").hide(),n=="contacto"?$("#contacto").fadeIn():$("#contacto").hide(),n=="ubicacion"?$("#ubicacion").fadeIn():$("#ubicacion").hide(),n=="compartir"?$("#compartir").fadeIn():$("#compartir").hide(),n=="guardar"?$("#guardar").fadeIn():$("#guardar").hide(),n=="acceso"?$("#acceso").fadeIn():$("#acceso").hide()}function Yn(n){if(n=="viewcopy"){$("#inputCopiar").select();var r=document.execCommand("copy");r?(console.log("Texto Copiado"),document.getElementById("aviso").innerHTML='<div class="alert alert-success">Texto Copiado!</div>'):console.log("> No copy to clipboard")}}function Kn(){const n=document.querySelector("#footerbar");n&&n.addEventListener("click",r=>{const s=r.target.id.replace("btn","").replace("1","").toLowerCase();s&&s!=""&&er(s)})}function Qn(n,r,s){var a=new Image;a.src=n,a.addEventListener("load",()=>{const e=s==0?"Logo":"Foto de perfil";console.log("Success: "+e),s==0?r.src=n:r.style.backgroundImage=`url('${n}')`}),a.addEventListener("error",()=>{const e=s==0?"logo":"foto de perfil";console.error("Error: Fallo carga de "+e)})}function yr(n,r,s,a){var e=new Image;e.src=n,e.addEventListener("load",()=>{const i=a==0?"Logo":"Foto de perfil";console.log("Success: "+i),a==0?s.src=n:s.style.backgroundImage=`url('${n}')`}),e.addEventListener("error",()=>{const i=a==0?"logo":"foto de perfil";r&&r!=""?Qn(r,s,a):console.error("Error: Fallo carga de "+i)})}const{host:ta,dominio:la,mod:da,ext:ca,id:X,URL:rr}=y();async function Zn(){const n=encodeURIComponent(rr);console.log(n);const r=await hr(X,j+"/vcard_vcard.json");if(console.log("Usuario",r),r==null){document.querySelector("#container").style.display="none";return}const{nombre:s,profile:a,puesto:e,descripcion:i,fb:o,tw:l,ins:c,lk:t,web:f,email:g,cell:d,tel_ofi:T,cover:k,idemp:w,visible:tr,direc:A}=r,x=await hr(w,j+"/vcard_vcard_empresas.json");console.log("Empresa",x);const{bg_color:I,coverbg:P,empresa:C}=x;er("inicio"),Kn(),document.querySelector("#head").style.backgroundColor=I;const H=X=="multiportal"?"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpprRNyywxrgFdZ7rLvnq-6jEgWCBq_4Js3A&s":null;yr(x.cover,H,document.querySelector("#logo"),0);const V=X=="multiportal"?"https://multiportal.webcindario.com/assets/img/Multiportal.logo2023.png":null;yr(k,V,document.querySelector("#fotoperfil"),1),document.querySelector("#tit").innerHTML=s,document.querySelector("#puesto").innerHTML=e,document.querySelector("#des").innerHTML=i;const F=document.querySelector("#medios"),G=d?`<a href="tel:${d}"><i class="fa fa-phone"></i><span>Llamar</span></a>`:"",R=d?`<a target="_blank" href="https://wa.me/+52${d}"><i class="fa fa-whatsapp"></i><span>WhatsApp</span></a>`:"",U=g?`<a href="mailto:${g}"><i class="fa fa-envelope-o"></i><span>E-mail</span></a>`:"",W=f?`<a href="${f}" target="_blank" id="empresaweb">${C}</a>`:"";F.innerHTML=G+R+U+W;const q=document.querySelector("#redes"),h=o?`
  ...
  <a href="${c}" target="_blank" aria-label="Instagram" class="icon-rrss">
    ...
    <span>Instagram</span>
  </a>`:"";q.innerHTML=`<div id="medios">${h} ${b} ${J} ${E}</div>`;const L=document.querySelector("#a-cell");d?L.setAttribute("href","tel:"+d):L.style.display="none";const D=document.querySelector("#a-wa");d?D.setAttribute("href","https://wa.me/+52"+d):D.style.display="none";const _=document.querySelector("#a-sms");d?_.setAttribute("href","sms:"+d):_.style.display="none";const O=document.querySelector("#a-email");g?O.setAttribute("href","mailto:"+g):O.style.display="none";const N=document.querySelector("#a-web");f?N.setAttribute("href",f):N.style.display="none";const z=document.querySelector("#ubi");z.innerHTML=A?`<p style="font-size: 18px;"><b>Dirección:</b> ${A}</p>
  <div id="map"></div>`:"<p>No hay dirección disponible.</p>";const lr=document.querySelector(".share"),Ar=`
  ...
  <a target="_blank" href="https://api.whatsapp.com/send?text=Accede+a+la+tarjeta+digital+desde+el+siguiente+enlace:+${n}" aria-label="whatsapp" class="icon-access">
    ...
    <span>WhatsApp</span>
  </a>`;lr.innerHTML=`${Ar}${Pr}${Cr}${Rr}`,document.querySelector("#inputCopiar").value=rr;const dr=document.querySelector("#viewcopy");dr&&dr.addEventListener("click",()=>{Yn("viewcopy")}),document.querySelector("#sendEmail").href="mailto:?body="+rr,document.querySelector("#saveCard").href=`files/vcf/${a}.vcf`;const cr=document.querySelector("#close");cr&&cr.addEventListener("click",()=>{er("inicio")})}function Xn(){setTimeout(()=>{Zn()},500)}function ra(n){const{route:r,hash:s,mod:a,ext:e,id:i,base_url:o}=n;u("log","route="+r),An(),a&&(Hn(a),Vn(a,o)),r=="dashboard/index"&&S(),r=="app/index"&&S(),r=="app/perfil"&&S(),r=="app/tarjetas"&&S(),r=="app/empresas"&&S(),(r=="vcard/index"||r=="vcard/profile")&&Xn(),r=="login/index"&&Mn(),r=="logout/index"&&Bn(),(a=="app"||a=="dashboard")&&Cn(s,r,a)}function y(){var n=window,r=document,s=n.location,a=new Date,e=a.getDate();e=e<10?"0"+e:e;var i=a.getMonth()+1;i=i<10?"0"+i:i;var o=a.getFullYear(),l=o+"-"+i+"-"+e;const{protocol:c,host:t,origin:f,pathname:g,hash:d,href:T,search:k}=s,w=f+"/",tr=f,A=T,x=k,I=g.replace("/",""),P=w+I,C=t=="localhost"||t!=nr&&t!=ar?I+M:M,H=t=="localhost:9001"?"../":"./",V=w+C,F=screen.width,G=screen.height;var R="default",U="temas/"+R+"/",W=hn(),q=yn(d,M);let{mod:h,ext:b,id:J}=kn(q);var E="/"+b,L=h+E,D=h||"",_=b&&b!="index"?"/"+b:"",O="#/"+D+_,N=P+Y+L+".html",z=P+Y+"404/index.html";return{w:n,d:r,loc:s,dt:a,day:e,mon:i,year:o,fecha:l,title:Vr,typeBack:Fr,typeDev:Gr,path_hash:M,path_src:wr,path_page:Y,hostDev:nr,hostPre:ar,protocol:c,host:t,dominio:w,dominio1:tr,pathname:g,hash:d,URL:A,quest:x,path_url:I,path_root:C,path_build:H,base_url:P,page_url:V,screenw:F,screenh:G,tema:R,path_tema:U,pag_name:W,vars_Url:q,mod:h,ext:b,id:J,ext2:E,route:L,hash2:O,url_mod:N,url404:z,apiVer:Wr}}function Tr(){const n=y();u("log",n);const{hash:r,mod:s,ext:a,id:e,page_url:i,base_url:o,title:l}=n;xn(r,s,a,e,l),ra(n),wn(r,s,xr),Sn(s,i),Pn(s,o)}function na(){console.log("Run function inicio"),Tr()}window.addEventListener("hashchange",()=>{u("warn","Event Listener"),Tr()});na();
