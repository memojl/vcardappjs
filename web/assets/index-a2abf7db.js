...
</div>`,se={Home:Re},Be={dashboard:'<!-- Begin page --><div id="wrapper">'+J+Y+'<div class="content-page">'+ke+Z+"</div></div><!-- END wrapper -->"+Q,app:'<!-- Begin page --><div id="wrapper" class="dashboard" style="display: none;">'+J+Y+'<div class="content-page">'+Ce+Z+"</div></div><!-- END wrapper -->"+Q+Ie+Le,dash:$e,tarjetas:Me,empresas:Ae,cuenta:Te,settings:_e,forget:Ee,login:qe,logout:je,registro:De,noauth:Pe},ie={...se,...Be},Oe=["dashboard","tarjetas","empresas","cuenta","settings"],ee={dash:{txt:"Dashboard",icon:"fas fa-tachometer-alt"},tarjetas:{txt:"Mis tarjetas",icon:"far fa-address-card"},empresas:{txt:"Mis empresas",icon:"fas fa-industry"}},Ue=`<div class="text-center">\r
...
`,le=e=>{var t=ie[e];return t=t??Ue,Ze(t)},He=async(e,t,n,a)=>{const r=`${e}/${t}`;let o=localStorage.getItem("Token");o=o&&o!=null?o:"";const l={...a,token:o},u=a!=null?JSON.stringify(l):"",v=await fetch(r,{method:n,headers:{"Content-Type":"application/json"},body:u});if(!v.ok)console.error("Error 404(Fetch): "),v=="Unauthorized"?console.error("Error 401(Fetch): "):v=="Forbidden"?console.error("Error 403(Fetch): "):v=="Not Found"&&console.error("Error 404(Fetch): ");else return await v.json()},Fe=async(e,t)=>{const{data:n}=await He(e,"profile/index.php","POST","");switch(t){case"InfoUser":return n.InfoUser;case"InfoToken":return n.InfoToken;default:return n}},te=async e=>{try{const t=await fetch(e);if(t.status==200){const n=await t.json();if(n)return n}else console.log("Error 404")}catch(t){console.log(t)}},{hash:Ne,host:Ve,hostDev:ze,typeBack:Et,apiVer:Ge}=q();function We(){var e=self.location.href,t=e.lastIndexOf("/"),n=e.substring(t+1,e.length);return n}function Ke(e,t){var n=e.replace("/"+t,""),a=n.split("/"),r=window.location.search.substring(1),o=r.split("&");return r==""&&(o=["mod="+a[1],"ext="+a[2],"id="+a[3]]),o}function Xe(e){for(var t=0;t<e.length;t++){var n=e[t].split("=");if(n[0]=="mod")var a=n[1];if(n[0]=="ext")var r=n[1];if(n[0]=="id")var o=n[1]}return a=a==""?"Home":a.replace("?",""),r=r==""||r=="undefined"?"index":r,o=o==""||o=="undefined"?"":o,{mod:a,ext:r,id:o}}function Qe(e,t,n,a){let r=localStorage.getItem("Token");document.querySelector("#menuweb");let o=document.querySelector(".user-login"),l=document.querySelector(".user-activo"),u=document.querySelector(".user-logout");n[t]&&(o.classList.remove("d-none"),l.classList.add("d-none"),u.classList.add("d-none"),r!=null&&r!=null&&r!="null"&&r!="undefined"&&(o.classList.add("d-none"),l.classList.remove("d-none"),u.classList.remove("d-none")))}const Ye=(e,t,n,a)=>{localStorage.getItem("Token"),w("log","hash=>"+e);let r=n!="index"?" / "+ne(n):"";document.title=a+" - "+ne(t)+r,Je(t,Oe);let o=t!="Home"&&n!="index"?n:t;console.log(o,t,n);let l=document.getElementById("app");if(l&&(l.innerHTML="",e))return l.appendChild(le(o))};function Je(e,t){var n=localStorage.getItem("Token");w("log","token="+n);let a=t.length;for(let r=0;r<a;r++)e===t[r]&&w("log","Accceso: "+e+"="+t[r]),e===t[r]&&(n==null||n=="undefined")&&(window.location.href="#/noauth");e=="login"&&n!=null&&n!="undefined"&&(window.location.href="#/dashboard")}function Ze(e){const t=document.createElement("div");return t.innerHTML=e,t}function et(e,t){(e==""||e=="undefined")&&(window.location.href=t)}function w(e,t){if(Ve==ze)switch(e){case"log":console.log(t);break;case"warn":console.warn(t);break;case"error":console.error(t);break;default:console.log(t);break}}function ne(e){return e[0].toUpperCase()+e.slice(1).toLowerCase()}function A(e,t){if(e.length>0)for(let r=0;r<e.length;r++)if(document.getElementById(t+r))w("log","Ok: "+t+r);else if(document.createStyleSheet)document.createStyleSheet(e[r]);else{var n="@import url('"+e[r]+"');",a=document.createElement("link");a.id=t+r,a.rel="stylesheet",a.href="data:text/css,"+escape(n),document.getElementsByTagName("head")[0].appendChild(a)}}function M(e,t){for(let n=0;n<e;n++){let a=document.getElementById(t+n);a&&document.getElementsByTagName("head")[0].removeChild(a)}}function tt(){let e=document.getElementsByTagName("body")[0],n=`<div class="layerLoading">
    <img src="./assets/img/loader-green.gif" alt=""/>
    <p>Cargando...</p>
  </div>`;var a=document.createElement("div");a.id="load",a.innerHTML=n,e.appendChild(a),setTimeout(()=>{let r=document.getElementById(a.id);r&&e.removeChild(r)},1500)}function nt(){const{mod:e,ext:t}=q();let n=e!="Home"&&t!="index"?t:e;var a=ie[n];e!="logout"&&e!="noauth"&&t=="index"&&a!=null&&tt()}async function rt(e,t){if(e=="Home"){const{version:n}=await te(`${t}assets/pwa/manifest.json`);console.log(`Version Actual: ${n}`);const a=await te(Ge);if(a&&a!=null){const{ultimate:r}=a.data[0];n!=r&&console.log(`Actualizar version ${e} (${n} => ${r})`)}else console.warn("No se pudo llevar a cabo la comprobación de versiones")}}function U(e){let t=e.getAttribute("data-menu");e.addEventListener("click",()=>{let n=document.getElementById("appDash");if(n&&(w("log","Click "+t),n.innerHTML="",Ne))return n.appendChild(le(t))})}const{host:at,dominio:ot,path_url:st,hostDev:it}=q();console.log("/* javascript login | VARIABLES CONSTANTES*/");let K=V+"/login/";at==it&&console.log("api_login="+K);function lt(){const e=document.getElementById("form-login");e!=null&&(e.addEventListener("submit",ct),console.log("btnLogin Activado"))}function ct(e){e.preventDefault(),console.log("Validación de Datos");let t=document.getElementById("username").value,n=document.getElementById("password").value;var a={username:t,password:n};const r=K+"index.php";fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}).then(o=>o.json()).then(o=>{const{data:l}=o;w("log",o),w("log","getToken:"+l.token),localStorage.setItem("Token",l.token);let u=localStorage.getItem("Token");w("log","Res-Token:"+u),u!=null&&u!="undefined"?location.href=ot+st+"#/dashboard":re(!1,0)}).catch(o=>{re(o,1)})}const re=(e,t)=>{e&&console.log(e);let n=document.getElementById("msj-error");n.innerHTML=`<div class="alert alert-danger" role="alert">${t==1?"<b>Error:</b>":""} Usuario o Contraseña Incorrectos</div>`},dt=()=>{const e=K+"";fetch(e).then(t=>t.json()).then(t=>{w("log",t)}).catch(t=>console.log(t)),setTimeout(function(){lt()},1e3)};function ut(){console.log("Logout/Salir"),localStorage.clear();var e=localStorage.getItem("Token");e==null&&(console.warn("TOKEN CLEAR"),setTimeout(function(){window.location.href="#/"},3e3))}function ce(){(function(e){var t=function(){};t.prototype.initTooltipPlugin=function(){e.fn.tooltip&&e('[data-toggle="tooltip"]').tooltip()},t.prototype.initPopoverPlugin=function(){e.fn.popover&&e('[data-toggle="popover"]').popover()},t.prototype.initToastPlugin=function(){e.fn.toast&&e('[data-toggle="toast"]').toast()},t.prototype.initSlimScrollPlugin=function(){e.fn.slimScroll&&e(".slimscroll").slimScroll({height:"auto",position:"right",size:"8px",touchScrollStep:20,color:"#9ea5ab"})},t.prototype.initFormValidation=function(){e(".needs-validation").on("submit",function(n){return e(this).addClass("was-validated"),e(this)[0].checkValidity()===!1?(n.preventDefault(),n.stopPropagation(),!1):!0})},t.prototype.initCustomModalPlugin=function(){e('[data-plugin="custommodal"]').on("click",function(n){n.preventDefault();var a=new Custombox.modal({content:{target:e(this).attr("href"),effect:e(this).attr("data-animation")},overlay:{color:e(this).attr("data-overlayColor")}});a.open()})},t.prototype.initCounterUp=function(){e(this).attr("data-delay")&&e(this).attr("data-delay"),e(this).attr("data-time")&&e(this).attr("data-time"),e('[data-plugin="counterup"]').each(function(n,a){e(this).counterUp({delay:100,time:1200})})},t.prototype.initPeityCharts=function(){e('[data-plugin="peity-pie"]').each(function(n,a){var r=e(this).attr("data-colors")?e(this).attr("data-colors").split(","):[],o=e(this).attr("data-width")?e(this).attr("data-width"):20,l=e(this).attr("data-height")?e(this).attr("data-height"):20;e(this).peity("pie",{fill:r,width:o,height:l})}),e('[data-plugin="peity-donut"]').each(function(n,a){var r=e(this).attr("data-colors")?e(this).attr("data-colors").split(","):[],o=e(this).attr("data-width")?e(this).attr("data-width"):20,l=e(this).attr("data-height")?e(this).attr("data-height"):20;e(this).peity("donut",{fill:r,width:o,height:l})}),e('[data-plugin="peity-donut-alt"]').each(function(n,a){e(this).peity("donut")}),e('[data-plugin="peity-line"]').each(function(n,a){e(this).peity("line",e(this).data())}),e('[data-plugin="peity-bar"]').each(function(n,a){var r=e(this).attr("data-colors")?e(this).attr("data-colors").split(","):[],o=e(this).attr("data-width")?e(this).attr("data-width"):20,l=e(this).attr("data-height")?e(this).attr("data-height"):20;e(this).peity("bar",{fill:r,width:o,height:l})})},t.prototype.initKnob=function(){e('[data-plugin="knob"]').each(function(n,a){e(this).knob()})},t.prototype.initTippyTooltips=function(){e('[data-plugin="tippy"]').length>0&&tippy('[data-plugin="tippy"]')},t.prototype.init=function(){this.initTooltipPlugin(),this.initPopoverPlugin(),this.initToastPlugin(),this.initSlimScrollPlugin(),this.initFormValidation(),this.initCustomModalPlugin(),this.initCounterUp(),this.initPeityCharts(),this.initKnob(),this.initTippyTooltips()},e.Components=new t,e.Components.Constructor=t})(window.jQuery),function(e){var t=function(){this.$body=e("body"),this.$portletIdentifier=".card",this.$portletCloser='.card a[data-toggle="remove"]',this.$portletRefresher='.card a[data-toggle="reload"]'};t.prototype.init=function(){var n=this;e(document).on("click",this.$portletCloser,function(a){a.preventDefault();var r=e(this).closest(n.$portletIdentifier),o=r.parent();r.remove(),o.children().length==0&&o.remove()}),e(document).on("click",this.$portletRefresher,function(a){a.preventDefault();var r=e(this).closest(n.$portletIdentifier);r.append('<div class="card-disabled"><div class="card-portlets-loader"></div></div>');var o=r.find(".card-disabled");setTimeout(function(){o.fadeOut("fast",function(){o.remove()})},500+300*(Math.random()*5))})},e.Portlet=new t,e.Portlet.Constructor=t}(window.jQuery),function(e){var t=function(){this.$body=e("body"),this.$window=e(window)};t.prototype._resetSidebarScroll=function(){e(".slimscroll-menu").slimscroll({height:"auto",position:"right",size:"8px",color:"#9ea5ab",wheelStep:5,touchScrollStep:20})},t.prototype.initMenu=function(){var n=this;e(".button-menu-mobile").on("click",function(a){a.preventDefault(),n.$body.toggleClass("sidebar-enable"),n.$window.width()>=768?n.$body.toggleClass("enlarged"):n.$body.removeClass("enlarged"),n._resetSidebarScroll()}),e("#side-menu").metisMenu(),n._resetSidebarScroll(),e(".right-bar-toggle").on("click",function(a){e("body").toggleClass("right-bar-enabled")}),e(document).on("click","body",function(a){e(a.target).closest(".right-bar-toggle, .right-bar").length>0||e(a.target).closest(".left-side-menu, .side-nav").length>0||e(a.target).hasClass("button-menu-mobile")||e(a.target).closest(".button-menu-mobile").length>0||(e("body").removeClass("right-bar-enabled"),e("body").removeClass("sidebar-enable"))}),e("#side-menu a").each(function(){var a=window.location.href.split(/[?#]/)[0];this.href==a&&(e(this).addClass("active"),e(this).parent().addClass("active"),e(this).parent().parent().addClass("in"),e(this).parent().parent().prev().addClass("active"),e(this).parent().parent().parent().addClass("active"),e(this).parent().parent().parent().parent().addClass("in"),e(this).parent().parent().parent().parent().parent().addClass("active"))}),e(".navbar-toggle").on("click",function(a){e(this).toggleClass("open"),e("#navigation").slideToggle(400)}),e(window).on("load",function(){e("#status").fadeOut(),e("#preloader").delay(350).fadeOut("slow")})},t.prototype.initLayout=function(){this.$window.width()>=768&&this.$window.width()<=1028?this.$body.addClass("enlarged"):this.$body.data("keep-enlarged")!=!0&&this.$body.removeClass("enlarged")},t.prototype.init=function(){var n=this;this.initLayout(),e.Portlet.init(),this.initMenu(),e.Components.init(),n.$window.on("resize",function(a){a.preventDefault(),n.initLayout(),n._resetSidebarScroll()})},e.App=new t,e.App.Constructor=t}(window.jQuery),function(e){e.App.init()}(window.jQuery),Waves.init()}const pt=q(),{host:de,dominio:qt,path_url:jt,base_url:Dt,screenw:vt,mod:Pt,hostDev:ue,year:gt}=pt;async function mt(){ce();let e=document.querySelector(".log-out");e!=null&&e.addEventListener("click",()=>{setTimeout(()=>{window.location.href="#/logout"},1e3)});let t=document.querySelector(".btn-set");t!=null&&t.addEventListener("click",()=>{window.location.href="#/dashboard/settings"});let n=document.querySelector(".user-edit");n!=null&&n.addEventListener("click",()=>{window.location.href="#/dashboard/cuenta"});let a=document.querySelector("#year");a&&(a.innerHTML=gt+" &copy; Xeria theme");let r=document.querySelectorAll(".arrow");for(var o=0;o<r.length;o++)r[o].addEventListener("click",m=>{m.target.parentElement.parentElement.classList.toggle("showMenu")});let l=document.querySelector(".sidebar"),u=document.querySelector(".bx-menu");if(u){let m=localStorage.getItem("bar");m=="true"&&l.classList.toggle("close"),u.addEventListener("click",()=>{let y=l.classList.toggle("close");localStorage.setItem("bar",y),m=localStorage.getItem("bar")}),console.log("Bar-Load:",m)}vt<=740&&l&&side.classList.add("close");const h=document.querySelector(".profile_name"),v=document.querySelector(".pro-user-name"),k=document.querySelector(".job");let _=de==ue?": DASHBOARD-GET PROFILE":"";if(console.log("AUTORIZADO"+_),h!=null&&k!=null&&v!=null){const{email:m,username:y,nombre:P,foto:C,puesto:x,status:z}=await Fe(V,"InfoUser");h&&(h.innerHTML=y),v&&(v.innerHTML=y+' <i class="mdi mdi-chevron-down"></i>'),k&&(k.innerHTML=x)}setTimeout(()=>{let m=document.querySelector(".slimscroll-menu");m&&(m.style.height="350px");let y=document.querySelector("#slimscroll-menu");y&&(y.style.height="250px")},100)}function ft(){setTimeout(function(){de==ue&&console.log("btnSidebar Activado"),mt()},500)}function ht(e,t){const n="app-",a=["https://fonts.googleapis.com/css?family=Muli:300,400,700",t+"assets/login/vendor/bootstrap/css/bootstrap.min.css",t+"assets/login/css/font.css",t+"assets/login/css/style.green.css",t+"assets/login/css/custom.css"];e=="app"?A(a,n):M(a.length,n);const r="dash-",o=[t+"assets/dashboard/xeria/assets/css/bootstrap.css",t+"assets/dashboard/xeria/assets/css/app.css"];e=="dashboard"?A(o,r):M(o.length,r);const l="login-",u=["https://fonts.googleapis.com/css?family=Muli:300,400,700",t+"assets/login/vendor/bootstrap/css/bootstrap.min.css",t+"assets/login/css/font.css",t+"assets/login/css/style.green.css",t+"assets/login/css/custom.css"];e!="login"&&e!="registro"?M(u.length,l):A(u,l);const h="home-",v=[t+"assets/tema/css/demo-business-consulting.css",t+"assets/tema/css/skin-business-consulting.css",t+"assets/tema/css/style.css"];e!="Home"?M(v.length,h):A(v,h)}function ae(e,t,n){const a="dash-",r=[t+"assets/dashboard/xeria/assets/css/bootstrap.css",t+"assets/dashboard/xeria/assets/css/app.css"];e=="app"&&n?A(r,a):M(r.length,a)}function bt(){const{mod:e,base_url:t}=q(),n=t;var a={apiKey:"AIzaSyDeX81H_K8AsV2KjQgEbwxte6yVdSYqFXk",authDomain:"vcardapp-js.firebaseapp.com",databaseURL:"https://vcardapp-js.firebaseio.com",projectId:"vcardapp-js",storageBucket:"vcardapp-js.appspot.com",messagingSenderId:"420720513571",appId:"1:420720513571:web:f072eeda6cd3cfa1429796",measurementId:"G-LDPZ4BZ1GV"};firebase.initializeApp(a),firebase.analytics();const r=firebase.database(),o=firebase.auth();firebase.firestore(),console.log("Modulo=>"+e),r.ref().child("vcard_config"),r.ref().child("vcard_signup");var l=r.ref().child("vcard_vcard"),u=r.ref().child("vcard_user"),h=r.ref().child("vcard_vcard_empresas");const v=document.querySelectorAll(".dashboard"),k=document.querySelectorAll(".right-bar"),_=document.querySelectorAll(".login-page"),m=document.querySelectorAll(".registro-page"),y=i=>{i?(v.forEach(s=>s.style.display="block"),k.forEach(s=>s.style.display="block"),_.forEach(s=>s.style.display="none"),m.forEach(s=>s.style.display="none")):(v.forEach(s=>s.style.display="none"),k.forEach(s=>s.style.display="none"),e=="registro"?(m.forEach(s=>s.style.display="block"),_.forEach(s=>s.style.display="none")):(m.forEach(s=>s.style.display="none"),_.forEach(s=>s.style.display="block")))},P=document.querySelector("#logout");P&&P.addEventListener("click",i=>{i.preventDefault(),o.signOut().then(()=>{console.log("signup out"),localStorage.clear();let s=localStorage.getItem("uid");ae(e,t,s),navigator.serviceWorker.getRegistrations().then(function(c){for(let d of c)d.unregister()})})});const C=document.querySelector("#registro-form");C&&C.addEventListener("submit",i=>{i.preventDefault();const s="Sin Nombre",c=C["register-email"].value,d=C["register-password"].value;var b={displayName:s,email:c,photoURL:null};o.createUserWithEmailAndPassword(c,d).then(f=>{console.log("Datos user: "+b),C.reset()})});const x=document.querySelector("#form-login");x&&x.addEventListener("submit",i=>{i.preventDefault();const s=x["login-email"].value,c=x["login-password"].value;o.signInWithEmailAndPassword(s,c).then(d=>{x.reset()})}),o.onAuthStateChanged(i=>{i?(console.log("User:",i),console.log("signin:"+i.email),localStorage.setItem("uid",i.uid),T(i.email),y(i),ae(e,t,i.uid)):(console.log("signout"),y(i))}),document.querySelector("#googleLogin").addEventListener("click",i=>{i.preventDefault(),x.reset(),j()}),document.querySelector("#googleRegister").addEventListener("click",i=>{i.preventDefault(),x.reset(),j()});function j(){const i=new firebase.auth.GoogleAuthProvider;o.signInWithPopup(i).then(s=>{console.log(s),console.log("google sign in")}).catch(s=>{console.log(s)})}function T(i){const s=document.querySelector("#foto"),c=document.querySelector("#foto1"),d=document.querySelector(".profile_name"),b=document.querySelector(".pro-user-name");r.ref("vcard_signup").on("child_added",function(f){var p=f.val(),g=p.foto==null?"./assets/img/sinfoto.png":p.foto,I=p.usuario==null?p.email:p.usuario;p.email==i&&(console.log("User Firebase:",p),s.setAttribute("src",g),c.setAttribute("src",g),d.innerHTML=I,b.innerHTML=p.email)})}function R(){var i="";l.orderByChild("orden").limitToFirst(10).on("child_added",function(c){var d=c.val();const{ID:b,cover:f,profile:p,nombre:g,puesto:I,f_create:L,visible:E}=d;if(E==1){i+=`
  <div class="public-user-block block">
    <div class="row d-flex align-items-center">                   
      <div class="col-lg-4 d-flex align-items-center">
        ...
        <a href="${n}../profile/${p}" class="name">
          <strong class="d-block">${g}</strong>
      ...
      <div class="col-lg-4">
        <div class="details d-flex">
          <div class="item"><i class="fa fa-calendar"></i><strong>${L}</strong></div>
  ...
  </div>`;const D=document.querySelector("#lista");D.innerHTML=i}})}e=="Home"&&R();let S=!0,B=1;$("#app-modulo").on("click",".btn-add",function(){$("#form1").trigger("reset"),fecha_hora_create(1),console.log("Boton Agregar activado");let i=l.orderByChild("ID");console.log(i),i.on("value",function(d){var b=d.val();let f=Object.values(b),p=f.length-1,g=f[p],I=parseInt(g.ID)+1;$("#ID").val(I);let L=parseInt(g.orden)-1;console.log(L),$("#orden").val(L)});let s=document.querySelector("#id_code_google");$("#uid").val(s.textContent);let c=document.querySelector("#email_session");$("#user").val(c.textContent),$("#cover").val(n+"bloques/files/images/photos/sinfoto.png"),$("#ima").attr("src",n+"bloques/files/images/photos/sinfoto.png"),S=!1}),$("#app-modulo").on("click",".btn-edit",function(){$("#form1").trigger("reset"),fecha_hora_update(1),console.log("Boton Editar activado");const i=$(this)[0].parentElement.parentElement.parentElement;let s=$(i).attr("vcardId");l.child(s).once("value",function(c){valor=c.val(),$("#cardId").val(s),$("#ID").val(valor.ID),$("#orden").val(valor.orden),$("#uid").val(valor.uid),$("#f_create").val(valor.f_create),$("#user").val(valor.user),$("#descripcion").val(valor.descripcion),$("#profile").val(valor.profile),$("#nombre").val(valor.nombre),$("#puesto").val(valor.puesto),$("#email").val(valor.email),$("#cell").val(valor.cell),$("#tel_ofi").val(valor.tel_ofi),$("#idemp").val(valor.idemp),$("#web").val(valor.web),$("#fb").val(valor.fb),$("#lk").val(valor.lk),$("#ins").val(valor.ins),$("#visible").val(valor.visible),$("#cover").val(valor.cover),$("#ima").attr("src",valor.cover)}),S=!0}),e=="tarjetas"&&$("#app-modulo").on("#form1").submit(function(i){i.preventDefault(),console.log("Form1");var s=$("#cardId").val();console.log(s);var c="";const d={ID:$("#ID").val(),orden:$("#orden").val(),uid:$("#uid").val(),f_create:$("#f_create").val(),f_update:$("#f_update").val(),user:$("#user").val(),descripcion:$("#descripcion").val(),cover:$("#cover").val(),profile:$("#profile").val(),nombre:$("#nombre").val(),puesto:$("#puesto").val(),email:$("#email").val(),web:$("#web").val(),cell:$("#cell").val(),tel_ofi:$("#tel_ofi").val(),idemp:$("#idemp").val(),fb:$("#fb").val(),lk:$("#lk").val(),ins:$("#ins").val(),visible:$("#visible").val()};console.log(d),S==!1?(c="Guardado",l.push(d)):(c="Actualizado",l.child(s).update(d)),console.log("Se ha "+c+" el registro"),$("#form1").trigger("reset"),$("#addVcard").modal("hide"),S=!1}),$("#app-modulo").on("click",".btn-delete",function(){var i=e=="tarjetas"?"Tarjeta":"Empresa";const s=$(this)[0].parentElement.parentElement.parentElement;let c=$(s).attr("vcardId");console.log(c),Swal.fire({title:"Esta seguro de eliminar esta "+i+"?",text:"¡Está operación no se puede revertir!",icon:"warning",showCancelButton:!0,confirmButtonColor:"#d33",cancelButtonColor:"#3085d6",confirmButtonText:"Borrar"}).then(d=>{d.value&&(refTable=e=="tarjetas"?l:h,refTable.child(c).remove(),Swal.fire("¡Eliminado!","La "+i+" ha sido eliminada.","success"))})}),$(document).on("click","#Aceptar",function(i){i.preventDefault();const s="https://cloudvcardjs.000webhostapp.com/";var c=new FormData;c.append("userfile",$("input[name=userfile]")[0].files[0]),$.ajax({url:s+"bloques/files/admin/backend.php?mod="+e+"&action=subir_cover",crossDomain:!0,type:"POST",data:c,processData:!1,contentType:!1,cache:!1,beforeSend:function(d){$("#imagen").html("Subiendo Imagen")},success:function(d){$("#imagen").html(d),$(".alert-dismissible").delay(3e3).fadeOut("slow"),console.log("Subido Correctamente")}})}),$(document).on("click","#Aceptar2",function(i){i.preventDefault();const s="https://cloudvcardjs.000webhostapp.com/";var c=new FormData;c.append("userfile2",$("input[name=userfile2]")[0].files[0]),$.ajax({url:s+"bloques/files/admin/backend.php?mod="+e+"&action=subir_coverbg",crossDomain:!0,type:"POST",data:c,processData:!1,contentType:!1,cache:!1,beforeSend:function(d){$("#imagen2").html("Subiendo Imagen")},success:function(d){$("#imagen2").html(d),$(".alert-dismissible").delay(3e3).fadeOut("slow"),console.log("Subido Correctamente")}})}),$("#q").keyup(function(i){if($("#q").val()){let s=$("#q").val();const c=document.querySelector("#lista");$.ajax({url:n+"bloques/files/admin/backend.php?action=buscar",type:"POST",data:{q:s},success:function(d){console.log(d),c.innerHTML=d}})}}),$("#searchForm").submit(function(i){i.preventDefault();const s=document.querySelector(".search-panel");s.style.display="none"}),$("#app-modulo").on("click",".btnAdd",function(){$("#form2").trigger("reset"),fecha_hora_create(1),console.log("Boton Agregar activado"),h.orderByChild("ID").on("value",function(c){var d=c.val();let b=Object.values(d),f=b.length-1,p=b[f],g=parseInt(p.ID)+1;$("#ID").val(g)});let s=document.querySelector("#id_code_google");$("#uid").val(s.textContent),$("#cover").val(n+"bloques/files/images/photos/sinlogo.jpg"),$("#coverbg").val(n+"bloques/files/images/photos/sinbg.jpg"),$("#ima").attr("src",n+"bloques/files/images/photos/sinlogo.jpg"),$("#ima2").attr("src",n+"bloques/files/images/photos/sinbg.jpg"),S=!1}),$("#app-modulo").on("click",".btnEditar",function(){console.log("bol="+B),$("#form2").trigger("reset"),fecha_hora_update(1),console.log("Boton Editar activado");const i=$(this)[0].parentElement.parentElement.parentElement;let s=$(i).attr("vcardId");h.child(s).once("value",function(c){valor=c.val(),console.log(valor),$("#cardId").val(s),$("#ID").val(valor.ID),$("#uid").val(valor.uid),$("#f_create").val(valor.f_create),$("#empresa").val(valor.empresa),$("#bg_color").val(valor.bg_color),$("#visible").val(valor.visible),$("#cover").val(valor.cover),$("#coverbg").val(valor.coverbg),$("#ima").attr("src",valor.cover),$("#ima2").attr("src",valor.coverbg)}),S=!0}),e=="empresas"&&$("#app-modulo").on("#form2").submit(function(i){i.preventDefault();var s=$("#cardId").val();console.log(s);var c="";const d={ID:$("#ID").val(),uid:$("#uid").val(),f_create:$("#f_create").val(),f_update:$("#f_update").val(),cover:$("#cover").val(),coverbg:$("#coverbg").val(),empresa:$("#empresa").val(),bg_color:$("#bg_color").val(),visible:$("#visible").val()};console.log(d),S==!1?(c="Guardado",h.push(d)):(c="Actualizado",h.child(s).update(d)),console.log("Se ha "+c+" el registro"),$("#form2").trigger("reset"),$("#empresaModal").modal("hide"),S=!1}),$("#app-modulo").on("click",".btnEditar3",function(){console.log("Bol="+B),$("#form3").trigger("reset"),fecha_hora_update(1),console.log("Boton Editar activado");const i=$(this)[0].parentElement.parentElement;let s=$(i).attr("vcardId");console.log(s),s==""&&fecha_hora_create(1);const c=document.querySelector(".contributions").textContent;console.log(c);const d=document.querySelector(".h5").textContent;console.log(d);const b=document.querySelector("#email_session").textContent;console.log(b);const f=document.querySelector("#ava").getAttribute("src");if(console.log(f),s!=""){const p=document.querySelector("#f_c").textContent;console.log(p),$("#f_create").val(p);const g=document.querySelector("#direc1").textContent;console.log(g),$("#direc").val(g);const I=document.querySelector("#tel1").textContent;console.log(I),$("#tel").val(I);const L=document.querySelector("#level1").textContent;console.log(L),$("#level").val(L);const E=document.querySelector("#tipoc1").textContent;console.log(E),$("#tipoc").val(E);const D=document.querySelector("#codi1").textContent;console.log(D),$("#codi").val(D)}$("#cardId").val(s),$("#uid").val(c),$("#nombre").val(d),$("#email").val(b),$("#cover").val(f),$("#ima").attr("src",f)}),e=="perfil"&&$("#app-modulo").on("#form3").submit(function(i){i.preventDefault();var s=$("#cardId").val();console.log(s);var c="";const d={foto:$("#cover").val(),uid:$("#uid").val(),email:$("#email").val(),f_create:$("#f_create").val(),f_update:$("#f_update").val(),usuario:$("#nombre").val(),direccion:$("#direc").val(),tel:$("#tel").val(),level:$("#level").val(),tipoc:$("#tipoc").val(),codi:$("#codi").val()};console.log(d),s==""?(c="Guardado",u.push(d)):(c="Actualizado",u.child(s).update(d)),console.log("Se ha "+c+" el registro"),$("#form2").trigger("reset"),$("#myModal").modal("hide"),S=!1})}const{host:yt,dominio:Tt,path_url:At,base_url:Mt,screenw:Rt,mod:Bt,hash:Ot,hostDev:wt,year:xt}=q();async function St(){ce();let e=document.querySelector("#side-menu");e&&e.addEventListener("click",()=>{document.body.classList.toggle("sidebar-enable")});for(let o in ee){const{txt:l,icon:u}=ee[o];e.innerHTML+=`
      <li>
        <a class="link btn-${o}" data-menu="${o}">
          <i class="${u}"></i>
          <span> ${l} </span>
        </a>
      </li>`;var t=document.querySelector(".btn-"+o);t!=null&&U(t)}let n=document.querySelector(".btn-set");n!=null&&n.addEventListener("click",()=>{window.location.href="#/app/settings"});let a=document.querySelector(".user-edit");a!=null&&a.addEventListener("click",()=>{window.location.href="#/app/cuenta"});let r=document.querySelector("#year");r&&(r.innerHTML=xt+" &copy; Xeria theme"),setTimeout(()=>{var o=document.querySelector(".btn-dash");o!=null&&U(o);let l=document.querySelector(".btn-tarjetas");l!=null&&U(l);let u=document.querySelector(".btn-empresas");u!=null&&U(u)},200),setTimeout(()=>{let o=document.querySelector(".slimscroll-menu");o&&(o.style.height="350px");let l=document.querySelector("#slimscroll-menu");l&&(l.style.height="250px")},100)}function kt(){setTimeout(function(){yt==wt&&console.log("btnSidebar Activado"),St(),bt()},500)}function Ct(){document.querySelector("nav");let e=document.querySelector(".header-body .header-btn-collapse-nav");e&&e.addEventListener("click",()=>{console.log("Click");let t=document.querySelector(".header-body"),a=document.querySelector(".header-body .show")?"auto":"251px";t.style.height=a})}function $t(){setTimeout(()=>{Ct()},500)}function It(e){const{route:t,mod:n,base_url:a}=e;w("log","route="+t),n&&(ht(n,a),nt()),t=="Home/index"&&$t(),t=="login/index"&&dt(),t=="logout/index"&&ut(),t=="dashboard/index"&&ft(),t=="app/index"&&kt()}function q(){var e=window,t=document,n=e.location,a=new Date,r=a.getDate();r=r<10?"0"+r:r;var o=a.getMonth()+1;o=o<10?"0"+o:o;var l=a.getFullYear(),u=l+"-"+o+"-"+r;const{protocol:h,host:v,origin:k,pathname:_,hash:m,href:y,search:P}=n,C=k+"/",x=k,z=y,X=P,j=_.replace("/",""),T=C+j,R=v=="localhost"||v!=F&&v!=N?j+O:O,S=v=="localhost:9001"?"../":"./",B=C+R,i=screen.width,s=screen.height;var c="default",d="temas/"+c+"/",b=We(),f=Ke(m,O);let{mod:p,ext:g,id:I}=Xe(f);var L="/"+g,E=p+L,D=p||"",ve=g&&g!="index"?"/"+g:"",ge="#/"+D+ve,me=T+W+E+".html",fe=T+W+"404/index.html";return{w:e,d:t,loc:n,dt:a,day:r,mon:o,year:l,fecha:u,title:ye,typeBack:we,typeDev:xe,path_hash:O,path_src:oe,path_page:W,hostDev:F,hostPre:N,protocol:h,host:v,dominio:C,dominio1:x,pathname:_,hash:m,URL:z,quest:X,path_url:j,path_root:R,path_build:S,base_url:T,page_url:B,screenw:i,screenh:s,tema:c,path_tema:d,pag_name:b,vars_Url:f,mod:p,ext:g,id:I,ext2:L,route:E,hash2:ge,url_mod:me,url404:fe,apiVer:Se}}function pe(){const e=q();w("log",e);const{hash:t,mod:n,ext:a,page_url:r,base_url:o,title:l}=e;Ye(t,n,a,l),It(e),Qe(t,n,se),et(n,r),rt(n,o)}function Lt(){console.log("Run function inicio"),pe()}window.addEventListener("hashchange",()=>{w("warn","Event Listener"),pe()});Lt();
