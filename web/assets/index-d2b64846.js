(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))e(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&e(i)}).observe(document,{childList:!0,subtree:!0});function r(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function e(a){if(a.ep)return;a.ep=!0;const s=r(a);fetch(a.href,s)}})();let pn=window.location;const{pathname:un,host:N}=pn;N!=="localhost"&&N!=="127.0.0.1:5173"&&"serviceWorker"in navigator&&navigator.serviceWorker.register(un+"sw.js").then(function(n){console.log("Service Worker registro correcto con scope: ",n.scope)}).catch(function(n){console.log("Service Worker registro fallo: ",n)});const{host:gn}=window.location,hn="VcardApp",y="#/",V="src/",j=V+"pages/",I="127.0.0.1:5173",B="127.0.0.1:4173",T=gn!=I?"https://apirestm.webcindario.com/api":"http://localhost/MisSitios/apirestm/api",mn=T+"/v2/api_version",vn=`<!-- ============================================================== -->\r
...
<!-- ============================================================== -->\r
<!-- End Page content -->\r
<!-- ============================================================== -->`,bn=`<div class="container text-center">\r
    <div class="row">\r
...
<!--//LOGIN-->`,wn=`<div class="container text-center">\r
    <h1>Logout</h1>\r
...
<!--//REGISTRO-->`,kn=`<div class="alert alert-warning" role="alert">\r
...
\r
    ...
    \r
        ...
        <!-- end Topbar -->`,v=`              <!-- Footer Start -->\r
            ...
            <!-- end Footer -->`,jn=`<div class="body">\r
...
</div>`,z={Home:jn},En={dashboard:'<!-- Begin page --><div id="wrapper">'+m+h+'<div class="content-page">'+vn+v+"<div></div><!-- END wrapper -->"+g,settings:'<!-- Begin page --><div id="wrapper">'+m+h+'<div class="content-page">'+fn+v+"</div></div><!-- END wrapper -->"+g,cuenta:'<!-- Begin page --><div id="wrapper">'+m+h+'<div class="content-page">'+Sn+v+"<div></div><!-- END wrapper -->"+g,empresas:'<!-- Begin page --><div id="wrapper">'+m+h+'<div class="content-page">'+Cn+v+"</div></div><!-- END wrapper -->"+g,tarjetas:'<!-- Begin page --><div id="wrapper">'+m+h+'<div class="content-page">'+Ln+v+"<div></div><!-- END wrapper -->"+g,forget:bn,login:yn,logout:wn,registro:xn,noauth:kn},W={...z,...En},Pn=["dashboard","settings"],In=`<div class="text-center">\r
...
`,Tn=n=>{var t=W[n];return t=t??In,Bn(t)},_n=async(n,t,r,e)=>{const a=`${n}/${t}`;let s=localStorage.getItem("Token");s=s&&s!=null?s:"";const i={...e,token:s},l=e!=null?JSON.stringify(i):"",o=await fetch(a,{method:r,headers:{"Content-Type":"application/json"},body:l});if(!o.ok)console.error("Error 404(Fetch): "),o=="Unauthorized"?console.error("Error 401(Fetch): "):o=="Forbidden"?console.error("Error 403(Fetch): "):o=="Not Found"&&console.error("Error 404(Fetch): ");else return await o.json()},An=async(n,t)=>{const{data:r}=await _n(n,"profile/index.php","POST","");switch(t){case"InfoUser":return r.InfoUser;case"InfoToken":return r.InfoToken;default:return r}},H=async n=>{try{const t=await fetch(n);if(t.status==200){const r=await t.json();if(r)return r}else console.log("Error 404")}catch(t){console.log(t)}};function Rn(){var n=self.location.href,t=n.lastIndexOf("/"),r=n.substring(t+1,n.length);return r}function Mn(n,t){var r=n.replace("/"+t,""),e=r.split("/"),a=window.location.search.substring(1),s=a.split("&");return a==""&&(s=["mod="+e[1],"ext="+e[2],"id="+e[3]]),s}function Dn(n){for(var t=0;t<n.length;t++){var r=n[t].split("=");if(r[0]=="mod")var e=r[1];if(r[0]=="ext")var a=r[1];if(r[0]=="id")var s=r[1]}return e=e==""?"Home":e.replace("?",""),a=a==""||a=="undefined"?"index":a,s=s==""||s=="undefined"?"":s,{mod:e,ext:a,id:s}}function On(n,t,r,e){let a=localStorage.getItem("Token");document.querySelector("#menuweb");let s=document.querySelector(".user-login"),i=document.querySelector(".user-activo"),l=document.querySelector(".user-logout");r[t]&&(s.classList.remove("d-none"),i.classList.add("d-none"),l.classList.add("d-none"),a!=null&&a!=null&&a!="null"&&a!="undefined"&&(s.classList.add("d-none"),i.classList.remove("d-none"),l.classList.remove("d-none")))}const qn=(n,t,r,e)=>{d("log","hash=>"+n);let a=r!="index"?" / "+U(r):"";document.title=e+" - "+U(t)+a,Nn(t,Pn);let s=t!="Home"&&r!="index"?r:t,i=document.getElementById("app");if(i.innerHTML="",n)return i.appendChild(Tn(s))};function Nn(n,t){var r=localStorage.getItem("Token");d("log","token="+r);let e=t.length;for(let a=0;a<e;a++)n===t[a]&&d("log","Accceso: "+n+"="+t[a]),n===t[a]&&(r==null||r=="undefined")&&(window.location.href="#/noauth");n=="login"&&r!=null&&r!="undefined"&&(window.location.href="#/dashboard")}function Bn(n){const t=document.createElement("div");return t.innerHTML=n,t}function Hn(n,t){(n==""||n=="undefined")&&(window.location.href=t)}function d(n,t){const{host:r,hostDev:e}=p();if(r==e)switch(n){case"log":console.log(t);break;case"warn":console.warn(t);break;case"error":console.error(t);break;default:console.log(t);break}}function U(n){return n[0].toUpperCase()+n.slice(1).toLowerCase()}function E(n,t){if(p(),n.length>0)for(let a=0;a<n.length;a++)if(document.getElementById(t+a))d("log","Ok: dash-"+a);else if(d("log",n[a]),document.createStyleSheet)document.createStyleSheet(n[a]);else{var r="@import url('"+n[a]+"');",e=document.createElement("link");e.id=t+a,e.rel="stylesheet",e.href="data:text/css,"+escape(r),document.getElementsByTagName("head")[0].appendChild(e)}}function P(n,t){for(let r=0;r<n;r++){let e=document.getElementById(t+r);e&&(d("log",e),document.getElementsByTagName("head")[0].removeChild(e))}}function Un(){let n=document.getElementsByTagName("body")[0],r=`<div class="layerLoading">
    <img src="./assets/img/loader-green.gif" alt=""/>
    <p>Cargando...</p>
  </div>`;var e=document.createElement("div");e.id="load",e.innerHTML=r,n.appendChild(e),setTimeout(()=>{let a=document.getElementById(e.id);a&&n.removeChild(a)},1500)}function Fn(){const{mod:n,ext:t}=p();let r=n!="Home"&&t!="index"?t:n;var e=W[r];n!="logout"&&n!="noauth"&&e!=null&&Un()}async function Vn(n){const{version:t}=await H(`${n}assets/pwa/manifest.json`);console.log(`Version Actual: ${t}`);const r=await H(mn);if(r&&r!=null){const{ultimate:e}=r.data[0];t!=e&&console.log(`Actualizar version (${t} => ${e})`)}else console.warn("No se pudo llevar a cabo la comprobación de versiones")}function zn(){document.querySelector("nav");let n=document.querySelector(".header-body .header-btn-collapse-nav");n&&n.addEventListener("click",()=>{console.log("Click");let t=document.querySelector(".header-body"),e=document.querySelector(".header-body .show")?"auto":"251px";t.style.height=e})}function Wn(){setTimeout(()=>{zn()},500)}const Jn=p(),{host:Kn,dominio:Qn,path_url:Gn,hostDev:Xn}=Jn;console.log("/* javascript login | VARIABLES CONSTANTES*/");let _=T+"/login/";Kn==Xn&&console.log("api_login="+_);function Yn(){const n=document.getElementById("form-login");n!=null&&(n.addEventListener("submit",Zn),console.log("btnLogin Activado"))}function Zn(n){n.preventDefault(),console.log("Validación de Datos");let t=document.getElementById("username").value,r=document.getElementById("password").value;var e={username:t,password:r};const a=_+"index.php";fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(s=>s.json()).then(s=>{const{data:i}=s;d("log",s),d("log","getToken:"+i.token),localStorage.setItem("Token",i.token);let l=localStorage.getItem("Token");d("log","Res-Token:"+l),l!=null&&l!="undefined"?location.href=Qn+Gn+"#/dashboard":F(!1,0)}).catch(s=>{F(s,1)})}const F=(n,t)=>{n&&console.log(n);let r=document.getElementById("msj-error");r.innerHTML=`<div class="alert alert-danger" role="alert">${t==1?"<b>Error:</b>":""} Usuario o Contraseña Incorrectos</div>`},$n=()=>{const n=_+"";fetch(n).then(t=>t.json()).then(t=>{d("log",t)}).catch(t=>console.log(t)),setTimeout(function(){Yn()},1e3)};function nt(){console.log("Logout/Salir"),localStorage.clear();var n=localStorage.getItem("Token");n==null&&(console.warn("TOKEN CLEAR"),setTimeout(function(){window.location.href="#/"},3e3))}function tt(){(function(n){var t=function(){};t.prototype.initTooltipPlugin=function(){n.fn.tooltip&&n('[data-toggle="tooltip"]').tooltip()},t.prototype.initPopoverPlugin=function(){n.fn.popover&&n('[data-toggle="popover"]').popover()},t.prototype.initToastPlugin=function(){n.fn.toast&&n('[data-toggle="toast"]').toast()},t.prototype.initSlimScrollPlugin=function(){n.fn.slimScroll&&n(".slimscroll").slimScroll({height:"auto",position:"right",size:"8px",touchScrollStep:20,color:"#9ea5ab"})},t.prototype.initFormValidation=function(){n(".needs-validation").on("submit",function(r){return n(this).addClass("was-validated"),n(this)[0].checkValidity()===!1?(r.preventDefault(),r.stopPropagation(),!1):!0})},t.prototype.initCustomModalPlugin=function(){n('[data-plugin="custommodal"]').on("click",function(r){r.preventDefault();var e=new Custombox.modal({content:{target:n(this).attr("href"),effect:n(this).attr("data-animation")},overlay:{color:n(this).attr("data-overlayColor")}});e.open()})},t.prototype.initCounterUp=function(){n(this).attr("data-delay")&&n(this).attr("data-delay"),n(this).attr("data-time")&&n(this).attr("data-time"),n('[data-plugin="counterup"]').each(function(r,e){n(this).counterUp({delay:100,time:1200})})},t.prototype.initPeityCharts=function(){n('[data-plugin="peity-pie"]').each(function(r,e){var a=n(this).attr("data-colors")?n(this).attr("data-colors").split(","):[],s=n(this).attr("data-width")?n(this).attr("data-width"):20,i=n(this).attr("data-height")?n(this).attr("data-height"):20;n(this).peity("pie",{fill:a,width:s,height:i})}),n('[data-plugin="peity-donut"]').each(function(r,e){var a=n(this).attr("data-colors")?n(this).attr("data-colors").split(","):[],s=n(this).attr("data-width")?n(this).attr("data-width"):20,i=n(this).attr("data-height")?n(this).attr("data-height"):20;n(this).peity("donut",{fill:a,width:s,height:i})}),n('[data-plugin="peity-donut-alt"]').each(function(r,e){n(this).peity("donut")}),n('[data-plugin="peity-line"]').each(function(r,e){n(this).peity("line",n(this).data())}),n('[data-plugin="peity-bar"]').each(function(r,e){var a=n(this).attr("data-colors")?n(this).attr("data-colors").split(","):[],s=n(this).attr("data-width")?n(this).attr("data-width"):20,i=n(this).attr("data-height")?n(this).attr("data-height"):20;n(this).peity("bar",{fill:a,width:s,height:i})})},t.prototype.initKnob=function(){n('[data-plugin="knob"]').each(function(r,e){n(this).knob()})},t.prototype.initTippyTooltips=function(){n('[data-plugin="tippy"]').length>0&&tippy('[data-plugin="tippy"]')},t.prototype.init=function(){this.initTooltipPlugin(),this.initPopoverPlugin(),this.initToastPlugin(),this.initSlimScrollPlugin(),this.initFormValidation(),this.initCustomModalPlugin(),this.initCounterUp(),this.initPeityCharts(),this.initKnob(),this.initTippyTooltips()},n.Components=new t,n.Components.Constructor=t})(window.jQuery),function(n){var t=function(){this.$body=n("body"),this.$portletIdentifier=".card",this.$portletCloser='.card a[data-toggle="remove"]',this.$portletRefresher='.card a[data-toggle="reload"]'};t.prototype.init=function(){var r=this;n(document).on("click",this.$portletCloser,function(e){e.preventDefault();var a=n(this).closest(r.$portletIdentifier),s=a.parent();a.remove(),s.children().length==0&&s.remove()}),n(document).on("click",this.$portletRefresher,function(e){e.preventDefault();var a=n(this).closest(r.$portletIdentifier);a.append('<div class="card-disabled"><div class="card-portlets-loader"></div></div>');var s=a.find(".card-disabled");setTimeout(function(){s.fadeOut("fast",function(){s.remove()})},500+300*(Math.random()*5))})},n.Portlet=new t,n.Portlet.Constructor=t}(window.jQuery),function(n){var t=function(){this.$body=n("body"),this.$window=n(window)};t.prototype._resetSidebarScroll=function(){n(".slimscroll-menu").slimscroll({height:"auto",position:"right",size:"8px",color:"#9ea5ab",wheelStep:5,touchScrollStep:20})},t.prototype.initMenu=function(){var r=this;n(".button-menu-mobile").on("click",function(e){e.preventDefault(),r.$body.toggleClass("sidebar-enable"),r.$window.width()>=768?r.$body.toggleClass("enlarged"):r.$body.removeClass("enlarged"),r._resetSidebarScroll()}),n("#side-menu").metisMenu(),r._resetSidebarScroll(),n(".right-bar-toggle").on("click",function(e){n("body").toggleClass("right-bar-enabled")}),n(document).on("click","body",function(e){n(e.target).closest(".right-bar-toggle, .right-bar").length>0||n(e.target).closest(".left-side-menu, .side-nav").length>0||n(e.target).hasClass("button-menu-mobile")||n(e.target).closest(".button-menu-mobile").length>0||(n("body").removeClass("right-bar-enabled"),n("body").removeClass("sidebar-enable"))}),n("#side-menu a").each(function(){var e=window.location.href.split(/[?#]/)[0];this.href==e&&(n(this).addClass("active"),n(this).parent().addClass("active"),n(this).parent().parent().addClass("in"),n(this).parent().parent().prev().addClass("active"),n(this).parent().parent().parent().addClass("active"),n(this).parent().parent().parent().parent().addClass("in"),n(this).parent().parent().parent().parent().parent().addClass("active"))}),n(".navbar-toggle").on("click",function(e){n(this).toggleClass("open"),n("#navigation").slideToggle(400)}),n(window).on("load",function(){n("#status").fadeOut(),n("#preloader").delay(350).fadeOut("slow")})},t.prototype.initLayout=function(){this.$window.width()>=768&&this.$window.width()<=1028?this.$body.addClass("enlarged"):this.$body.data("keep-enlarged")!=!0&&this.$body.removeClass("enlarged")},t.prototype.init=function(){var r=this;this.initLayout(),n.Portlet.init(),this.initMenu(),n.Components.init(),r.$window.on("resize",function(e){e.preventDefault(),r.initLayout(),r._resetSidebarScroll()})},n.App=new t,n.App.Constructor=t}(window.jQuery),function(n){n.App.init()}(window.jQuery),Waves.init()}const rt=p(),{host:J,dominio:ct,path_url:pt,base_url:ut,screenw:et,mod:gt,hostDev:K}=rt;async function at(){tt();let n=document.querySelector(".log-out");n!=null&&n.addEventListener("click",()=>{window.location.href="#/logout"});let t=document.querySelector(".btn-set");t!=null&&t.addEventListener("click",()=>{window.location.href="#/dashboard/settings"});let r=document.querySelectorAll(".arrow");for(var e=0;e<r.length;e++)r[e].addEventListener("click",o=>{o.target.parentElement.parentElement.classList.toggle("showMenu")});let a=document.querySelector(".sidebar"),s=document.querySelector(".bx-menu");if(s!=null){let o=localStorage.getItem("bar");o=="true"&&a.classList.toggle("close"),s.addEventListener("click",()=>{let c=a.classList.toggle("close");localStorage.setItem("bar",c),o=localStorage.getItem("bar")}),console.log("Bar-Load:",o)}et<=740&&a&&side.classList.add("close");const i=document.querySelector(".profile_name"),l=document.querySelector(".job");let f=J==K?": DASHBOARD-GET PROFILE":"";if(console.log("AUTORIZADO"+f),i!=null&&l!=null){const{email:o,username:c,nombre:w,foto:x,puesto:k,status:A}=await An(T,"InfoUser");i!=null&&(i.innerHTML=c),l!=null&&(l.innerHTML=k)}}function st(){setTimeout(function(){J==K&&console.log("btnSidebar Activado"),at()},500)}function it(n,t){const r="dash-",e=[t+"assets/dashboard/xeria/assets/css/bootstrap.css",t+"assets/dashboard/xeria/assets/css/app.css"];n=="dashboard"?E(e,r):P(e.length,r);const a="login-",s=["https://fonts.googleapis.com/css?family=Muli:300,400,700",t+"assets/login/vendor/bootstrap/css/bootstrap.min.css",t+"assets/login/css/font.css",t+"assets/login/css/style.green.css",t+"assets/login/css/custom.css"];n!="login"&&n!="registro"?P(s.length,a):E(s,a);const i="home-",l=[t+"assets/tema/css/demo-business-consulting.css",t+"assets/tema/css/skin-business-consulting.css",t+"assets/tema/css/style.css"];n!="Home"?P(l.length,i):E(l,i)}function ot(n){const{route:t,mod:r,base_url:e}=n;d("log","route="+t),r&&(it(r,e),Fn()),t=="Home/index"&&Wn(),t=="login/index"&&$n(),t=="logout/index"&&nt(),(t=="dashboard/index"||r=="dashboard")&&st()}function p(){var n=window,t=document,r=n.location,e=new Date,a=e.getDate();a=a<10?"0"+a:a;var s=e.getMonth()+1;s=s<10?"0"+s:s;var i=e.getFullYear(),l=i+"-"+s+"-"+a;const{protocol:f,host:o,origin:c,pathname:w,hash:x,href:k,search:A}=r,S=c+"/",G=c,X=k,Y=A,C=w.replace("/",""),L=S+C,R=o=="localhost"||o!=I&&o!=B?C+y:y,Z=o=="localhost:9001"?"../":"./",$=S+R,nn=screen.width,tn=screen.height;var M="default",rn="temas/"+M+"/",en=Rn(),D=Mn(x,y);let{mod:b,ext:u,id:an}=Dn(D);var O="/"+u,q=b+O,sn=b||"",on=u&&u!="index"?"/"+u:"",ln="#/"+sn+on,dn=L+j+q+".html",cn=L+j+"404/index.html";return{w:n,d:t,loc:r,dt:e,day:a,mon:s,year:i,fecha:l,title:hn,path_hash:y,path_src:V,path_page:j,hostDev:I,hostPre:B,protocol:f,host:o,dominio:S,dominio1:G,pathname:w,hash:x,URL:X,quest:Y,path_url:C,path_root:R,path_build:Z,base_url:L,page_url:$,screenw:nn,screenh:tn,tema:M,path_tema:rn,pag_name:en,vars_Url:D,mod:b,ext:u,id:an,ext2:O,route:q,hash2:ln,url_mod:dn,url404:cn}}function Q(){const n=p();d("log",n);const{hash:t,mod:r,ext:e,page_url:a,base_url:s,title:i}=n;qn(t,r,e,i),ot(n),On(t,r,z),Hn(r,a),Vn(s)}function lt(){console.log("Run function inicio"),Q()}window.addEventListener("hashchange",()=>{d("warn","Event Listener"),Q()});lt();
