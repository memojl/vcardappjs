...
`,vn=n=>{var r=Ir[n];return r=r??pn,In(r)},{host:mn,year:un,hostDev:gn,typeBack:fn}=f();function bn(){var n=self.location.href,r=n.lastIndexOf("/"),s=n.substring(r+1,n.length);return s}function hn(n,r){var s=n.replace("/"+r,""),a=s.split("/"),e=window.location.search.substring(1),i=e.split("&");return e==""&&(i=["mod="+a[1],"ext="+a[2],"id="+a[3]]),i}function yn(n,r){const s=r?r.split("/"):n.split("/");console.log(s);var a=s[1]===""?"Home":s[1],e=s[2]===""||s[2]===void 0?"index":s[2],i=s[3]===""||s[3]===void 0?"":s[3];return{mod:a,ext:e,id:i}}function kn(n,r,s,a){let e=localStorage.getItem("Token");document.querySelector("#menuweb");let i=document.querySelector(".user-login"),t=document.querySelector(".user-activo"),l=document.querySelector(".user-logout");s[r]&&(i.classList.remove("d-none"),t.classList.add("d-none"),l.classList.add("d-none"),e!=null&&e!=null&&e!="null"&&e!="undefined"&&(i.classList.add("d-none"),t.classList.remove("d-none"),l.classList.remove("d-none")))}const xn=(n,r,s,a,e)=>{localStorage.getItem("Token"),O("log","hash=>"+n);let i=r=="vcard"?"":Y(r),t=s!="index"?""+Y(s):"",l=a!=""?" / "+Y(a):"";document.title=e+" - "+i+t+l,wn(r,dn);let c=r!="Home"&&s!="index"?s:r,o=document.getElementById("app");if(o)return o.innerHTML="",o.appendChild(vn(c))};function wn(n,r){var s=localStorage.getItem("Token");O("log","token="+s);let a=r.length;for(let e=0;e<a;e++)n===r[e]&&O("log","Accceso: "+n+"="+r[e]),n===r[e]&&(s==null||s=="undefined")&&(window.location.href="#/noauth");n=="login"&&s!=null&&s!="undefined"&&(window.location.href="#/dashboard")}function In(n){const r=document.createElement("div");return r.innerHTML=n,r}function Ln(n,r){(n==""||n=="undefined")&&(window.location.href=r)}function O(n,r){if(mn==gn)switch(n){case"log":console.log(r);break;case"warn":console.warn(r);break;case"error":console.error(r);break;default:console.log(r);break}}function Y(n){return n[0].toUpperCase()+n.slice(1).toLowerCase()}function z(n,r){if(n.length>0){for(let e=0;e<n.length;e++)if(!document.getElementById(r+e))if(document.createStyleSheet)document.createStyleSheet(n[e]);else{var s="@import url('"+n[e]+"');",a=document.createElement("link");a.id=r+e,a.rel="stylesheet",a.href="data:text/css,"+escape(s),document.getElementsByTagName("head")[0].appendChild(a)}}}function K(n,r){for(let s=0;s<n.length;s++){let a=document.getElementById(r+s);a&&document.getElementsByTagName("head")[0].removeChild(a)}}function mr(n,r,s){if(n.length>0)for(let e=0;e<n.length;e++){let i=document.getElementById(r+e);if(i&&document.body.removeChild(i),s=="load"&&!document.getElementById(r+e)){var a=document.createElement("script");a.id=r+e,a.src=n[e],document.body.appendChild(a)}}}function ur(n,r){if(n.length>0){for(let a=0;a<n.length;a++)if(!document.getElementById(r+a)){var s=document.createElement("script");s.id=r+a,s.src=n[a],document.body.appendChild(s)}}}function gr(n,r){for(let s=0;s<n.length;s++){let a=document.getElementById(r+s);a&&document.body.removeChild(a)}}function Sn(){const n=document.querySelector("#footer_page");n&&(n.innerHTML=un+' &copy; VcardAppJS V.3.0.1 (Vite - MandragoraJS). Diseñada por <a target="_blank" href="http://multiportal.com.mx">[:MULTIPORTAL:]</a>.')}function _n(){let n=document.getElementsByTagName("body")[0],s=`<div class="layerLoading">
  ...
  <a href="${c}" target="_blank" aria-label="Instagram" class="icon-rrss">
    ...
    <span>Instagram</span>
  </a>`:"";u.innerHTML=`<div id="medios">${m} ${W} ${P} ${j}</div>`;const T=document.querySelector("#a-cell");d?T.setAttribute("href","tel:"+d):T.style.display="none";const A=document.querySelector("#a-wa");d?A.setAttribute("href","https://wa.me/+52"+d):A.style.display="none";const R=document.querySelector("#a-sms");d?R.setAttribute("href","sms:"+d):R.style.display="none";const q=document.querySelector("#a-email");v?q.setAttribute("href","mailto:"+v):q.style.display="none";const D=document.querySelector("#a-web");p?D.setAttribute("href",p):D.style.display="none";const lr=document.querySelector("#ubi");lr.innerHTML=I?`<p style="font-size: 18px;"><b>Dirección:</b> ${I}</p>
  ...
  <a target="_blank" href="https://api.whatsapp.com/send?text=Accede+a+la+tarjeta+digital+desde+el+siguiente+enlace:+${n}" aria-label="whatsapp" class="icon-access">
    ...
    <span>WhatsApp</span>
  </a>`;_r.innerHTML=`${Pr}${jr}${Tr}${Ar}`,document.querySelector("#inputCopiar").value=X;const dr=document.querySelector("#viewcopy");dr&&dr.addEventListener("click",()=>{Fn()}),document.querySelector("#sendEmail").href="mailto:?body="+X,document.querySelector("#saveCard").href=`files/vcf/${a}.vcf`;const cr=document.querySelector("#close");cr&&cr.addEventListener("click",()=>{ar("inicio")})}function Jn(){setTimeout(()=>{Wn()},500)}function Yn(n){const{route:r,hash:s,mod:a,base_url:e}=n;O("log","route="+r),Pn(),a&&($n(a),Mn(a,e)),r=="dashboard/index"&&g(),r=="registro/index"&&g(),r=="app/index"&&g(),r=="dashboard/perfil"&&g(),r=="dashboard/tarjetas"&&g(),r=="dashboard/empresas"&&g(),(r=="vcard/index"||r=="vcard/profile")&&Jn(),r=="logout/index"&&On(),(a=="app"||a=="dashboard")&&Tn(s,r,a)}function f(){var n=window,r=document,s=n.location,a=new Date,e=a.getDate();e=e<10?"0"+e:e;var i=a.getMonth()+1;i=i<10?"0"+i:i;var t=a.getFullYear(),l=t+"-"+i+"-"+e;const{protocol:c,host:o,origin:p,pathname:v,hash:d,href:w,search:b}=s,h=p+"/",or=p,I=w,y=b,k=v.replace("/",""),L=h+k,S=o=="localhost"||o!=rr&&o!=nr?k+C:C,x=o=="localhost:9001"?"../":"./",B=h+S,H=screen.width,G=screen.height;var _="default",F="temas/"+_+"/",U=bn(),V=hn(d,C);let{mod:u,ext:m,id:W}=yn(v,d);var P="/"+m,j=u+P,T=u||"",A=m&&m!="index"?"/"+m:"",R="#/"+T+A,q=L+J+j+".html",D=L+J+"404/index.html";return{w:n,d:r,loc:s,dt:a,day:e,mon:i,year:t,fecha:l,title:Mr,typeBack:Br,typeDev:Hr,path_hash:C,path_src:xr,path_page:J,hostDev:rr,hostPre:nr,protocol:c,host:o,dominio:h,dominio1:or,pathname:v,hash:d,URL:I,quest:y,path_url:k,path_root:S,path_build:x,base_url:L,page_url:B,screenw:H,screenh:G,tema:_,path_tema:F,pag_name:U,vars_Url:V,mod:u,ext:m,id:W,ext2:P,route:j,hash2:R,url_mod:q,url404:D,apiVer:Fr}}function tr(){const n=f();console.log(n);const{hash:r,mod:s,ext:a,id:e,page_url:i,title:t}=n;xn(r,s,a,e,t),Yn(n),kn(r,s,wr),Ln(s,i),jn()}function zn(){console.log("Run function inicio"),tr()}window.addEventListener("hashchange",()=>{tr()});document.addEventListener("click",n=>{const{target:r}=n;r.matches("nav li a")&&(n.preventDefault(),Sr())});const Sr=n=>{n=n||window.event,n.preventDefault(),window.history.pushState({},"",n.target.href),tr()};window.route=Sr;zn();
