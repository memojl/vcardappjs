...
</nav>`,pn=["dashboard","settings","perfil","tarjetas","empresas"],mn={forget:Wr,login:Jr,logout:zr,noauth:Yr,registro:Kr,dashboard:Qr,settings:Zr,perfil:Xr,tarjetas:rn,empresas:nn},kr={Home:an,app:en,vcard:sn,profile:on,nosotros:N+tn,productos:N+ln,categorias:N+dn,contacto:N+cn},wr={...kr,...mn},cr=[{txt:"Dashboard",icon:"icon-dashboard",link:"/#/app"},{txt:"Dashboard",icon:"icon-dashboard",link:"/#/dashboard"},{txt:"Perfil",icon:"fa fa-user",link:"/#/app/perfil"},{txt:"Mis tarjetas",icon:"fa fa-vcard",link:"/#/app/tarjetas"},{txt:"Mis empresas",icon:"fa fa-industry",link:"/#/app/empresas"}],vn=`<div class="text-center">\r
...
`,un=n=>{var r=wr[n];return r=r??vn,Sn(r)},pr=async n=>{try{const r=await fetch(n);if(r.status==200){const s=await r.json();if(s)return s}else console.log("Error 404")}catch(r){console.log(r)}},{hash:ta,host:gn,year:fn,hostDev:bn,typeBack:xr,apiVer:hn}=f();function yn(){var n=self.location.href,r=n.lastIndexOf("/"),s=n.substring(r+1,n.length);return s}function kn(n,r){var s=n.replace("/"+r,""),e=s.split("/"),a=window.location.search.substring(1),i=a.split("&");return a==""&&(i=["mod="+e[1],"ext="+e[2],"id="+e[3]]),i}function wn(n){for(var r=0;r<n.length;r++){var s=n[r].split("=");if(s[0]=="mod")var e=s[1];if(s[0]=="ext")var a=s[1];if(s[0]=="id")var i=s[1]}return e=e==""?"Home":e.replace("?",""),a=a==""||a=="undefined"?"index":a,i=i==""||i=="undefined"?"":i,{mod:e,ext:a,id:i}}function xn(n,r,s,e){let a=localStorage.getItem("Token");document.querySelector("#menuweb");let i=document.querySelector(".user-login"),o=document.querySelector(".user-activo"),l=document.querySelector(".user-logout");s[r]&&(i.classList.remove("d-none"),o.classList.add("d-none"),l.classList.add("d-none"),a!=null&&a!=null&&a!="null"&&a!="undefined"&&(i.classList.add("d-none"),o.classList.remove("d-none"),l.classList.remove("d-none")))}const In=(n,r,s,e,a)=>{localStorage.getItem("Token"),p("log","hash=>"+n);let i=r=="vcard"?"":K(r),o=s!="index"?""+K(s):"",l=e!=""?" / "+K(e):"";document.title=a+" - "+i+o+l,Ln(r,pn);let c=r!="Home"&&s!="index"?s:r,t=document.getElementById("app");if(t&&(t.innerHTML="",n))return t.appendChild(un(c))};function Ln(n,r){var s=localStorage.getItem("Token");p("log","token="+s);let e=r.length;for(let a=0;a<e;a++)n===r[a]&&p("log","Accceso: "+n+"="+r[a]),n===r[a]&&(s==null||s=="undefined")&&(window.location.href="#/noauth");n=="login"&&s!=null&&s!="undefined"&&(window.location.href="#/dashboard")}function Sn(n){const r=document.createElement("div");return r.innerHTML=n,r}function jn(n,r){(n==""||n=="undefined")&&(window.location.href=r)}function p(n,r){if(gn==bn)switch(n){case"log":console.log(r);break;case"warn":console.warn(r);break;case"error":console.error(r);break;default:console.log(r);break}}function K(n){return n[0].toUpperCase()+n.slice(1).toLowerCase()}function Q(n,r){if(n.length>0)for(let a=0;a<n.length;a++)if(console.log("load",r+a),document.getElementById(r+a))console.log("Reload Ok: "+r+a);else if(console.log(r+a,n[a]),document.createStyleSheet)document.createStyleSheet(n[a]);else{var s="@import url('"+n[a]+"');",e=document.createElement("link");e.id=r+a,e.rel="stylesheet",e.href="data:text/css,"+escape(s),document.getElementsByTagName("head")[0].appendChild(e)}}function Z(n,r){for(let s=0;s<n.length;s++){console.log("delete",r+s);let e=document.getElementById(r+s);e&&document.getElementsByTagName("head")[0].removeChild(e)}}function mr(n,r,s){if(n.length>0)for(let a=0;a<n.length;a++){console.log("load",r+a);let i=document.getElementById(r+a);if(i&&document.body.removeChild(i),s=="load")if(document.getElementById(r+a))console.log("Reload Ok: "+r+a);else{console.log(r+a,n[a]);var e=document.createElement("script");e.id=r+a,e.src=n[a],document.body.appendChild(e)}}}function vr(n,r){if(n.length>0)for(let e=0;e<n.length;e++)if(console.log("load",r+e),document.getElementById(r+e))console.log("Reload Ok: "+r+e);else{console.log(r+e,n[e]);var s=document.createElement("script");s.id=r+e,s.src=n[e],document.body.appendChild(s)}}function ur(n,r){for(let s=0;s<n.length;s++){console.log("delete",r+s);let e=document.getElementById(r+s);e&&document.body.removeChild(e)}}function Tn(){const n=document.querySelector("#footer_page");n.innerHTML=fn+' &copy; VcardAppJS V.3.0.1 (Vite - MandragoraJS). Diseñada por <a target="_blank" href="http://multiportal.com.mx">[:MULTIPORTAL:]</a>.'}function An(){let n=document.getElementsByTagName("body")[0],s=`<div class="layerLoading">
  ...
  <a href="${l}" target="_blank" aria-label="Instagram" class="icon-rrss">
    ...
    <span>Instagram</span>
  </a>`:"";G.innerHTML=`<div id="medios">${R} ${u} ${v} ${W}</div>`;const x=document.querySelector("#a-cell");d?x.setAttribute("href","tel:"+d):x.style.display="none";const I=document.querySelector("#a-wa");d?I.setAttribute("href","https://wa.me/+52"+d):I.style.display="none";const q=document.querySelector("#a-sms");d?q.setAttribute("href","sms:"+d):q.style.display="none";const E=document.querySelector("#a-email");m?E.setAttribute("href","mailto:"+m):E.style.display="none";const D=document.querySelector("#a-web");t?D.setAttribute("href",t):D.style.display="none";const J=document.querySelector("#ubi");J.innerHTML=T?`<p style="font-size: 18px;"><b>Dirección:</b> ${T}</p>
  <div id="map"></div>`:"<p>No hay dirección disponible.</p>";const _=document.querySelector(".share");console.warn(_);const or=`
  <a target="_blank" href="//www.facebook.com/sharer.php?u=${encodeURIComponent(g)}&t=Vcard+${s}" aria-label="Facebook" class="icon-access">
    <i class="fa fa-facebook"></i>
    <span>Facebook</span>
  </a>`,jr=`
  <a target="_blank" href="//twitter.com/share?url=${encodeURIComponent(g)}&text=Vcard+${s}" aria-label="Twitter" class="icon-access">
    <i class="fa fa-twitter"></i>
    <span>Twitter</span>
  </a>`,Tr=`
  <a target="_blank" href="//www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(g)}&title=${s}&ro=false&summary=&source=" aria-label="LinkedIn" class="icon-access">
    <i class="fa fa-linkedin"></i>
    <span>LinkedIn</span>
  </a>`,Ar=`
  <a target="_blank" href="https://api.whatsapp.com/send?text=Accede+a+la+tarjeta+digital+desde+el+siguiente+enlace:+${encodeURIComponent(g)}" aria-label="whatsapp" class="icon-access">
    <i class="fa fa-whatsapp"></i>
    <span>WhatsApp</span>
  </a>`;_.innerHTML=`${or}${jr}${Tr}${Ar}`,document.querySelector("#inputCopiar").value=g;const tr=document.querySelector("#viewcopy");tr&&tr.addEventListener("click",()=>{Kn("viewcopy")}),document.querySelector("#sendEmail").href="mailto:?body="+g,document.querySelector("#saveCard").href=`files/vcf/${s}.vcf`;const lr=document.querySelector("#close");lr&&lr.addEventListener("click",()=>{ar("inicio")})}function ra(){setTimeout(()=>{Xn()},500)}function na(n){const{route:r,hash:s,mod:e,ext:a,id:i,base_url:o}=n;p("log","route="+r),Pn(),e&&(Vn(e),Fn(e,o)),r=="dashboard/index"&&L(),r=="app/index"&&L(),r=="app/perfil"&&L(),r=="app/tarjetas"&&L(),r=="app/empresas"&&L(),(r=="vcard/index"||r=="vcard/profile")&&ra(),r=="login/index"&&Bn(),r=="logout/index"&&Hn(),(e=="app"||e=="dashboard")&&Rn(s,r,e)}function f(){var n=window,r=document,s=n.location,e=new Date,a=e.getDate();a=a<10?"0"+a:a;var i=e.getMonth()+1;i=i<10?"0"+i:i;var o=e.getFullYear(),l=o+"-"+i+"-"+a;const{protocol:c,host:t,origin:m,pathname:d,hash:b,href:h,search:y}=s,j=m+"/",T=m,k=h,M=y,A=d.replace("/",""),w=j+A,P=t=="localhost"||t!=rr&&t!=nr?A+O:O,B=t=="localhost:9001"?"../":"./",H=j+P,V=screen.width,F=screen.height;var C="default",U="temas/"+C+"/",G=yn(),R=kn(b,O);let{mod:u,ext:v,id:W}=wn(R);var x="/"+v,I=u+x,q=u||"",E=v&&v!="index"?"/"+v:"",D="#/"+q+E,J=w+Y+I+".html",_=w+Y+"404/index.html";return{w:n,d:r,loc:s,dt:e,day:a,mon:i,year:o,fecha:l,title:Hr,typeBack:Vr,typeDev:Fr,path_hash:O,path_src:yr,path_page:Y,hostDev:rr,hostPre:nr,protocol:c,host:t,dominio:j,dominio1:T,pathname:d,hash:b,URL:k,quest:M,path_url:A,path_root:P,path_build:B,base_url:w,page_url:H,screenw:V,screenh:F,tema:C,path_tema:U,pag_name:G,vars_Url:R,mod:u,ext:v,id:W,ext2:x,route:I,hash2:D,url_mod:J,url404:_,apiVer:Gr}}function Sr(){const n=f();p("log",n);const{hash:r,mod:s,ext:e,id:a,page_url:i,base_url:o,title:l}=n;In(r,s,e,a,l),na(n),xn(r,s,kr),jn(s,i),Cn(s,o)}function aa(){console.log("Run function inicio"),Sr()}window.addEventListener("hashchange",()=>{p("warn","Event Listener"),Sr()});aa();
