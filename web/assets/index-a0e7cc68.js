import{getAuth as ge,GoogleAuthProvider as pe,signInWithPopup as ue,signOut as ve,onAuthStateChanged as fe}from"https://www.gstatic.com/firebasejs/10.4.0/firebase-auth.js";import{initializeApp as he}from"https://www.gstatic.com/firebasejs/10.4.0/firebase-app.js";import{getFirestore as be}from"https://www.gstatic.com/firebasejs/10.4.0/firebase-firestore.js";import{getDatabase as ye,set as je,ref as ke}from"https://www.gstatic.com/firebasejs/10.4.0/firebase-database.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();let we=window.location;const{pathname:xe,host:w}=we;w!=="localhost"&&w!=="localhost:5173"&&w!=="127.0.0.1:5173"&&"serviceWorker"in navigator&&navigator.serviceWorker.register(xe+"sw.js").then(function(n){console.log("Service Worker registro correcto con scope: ",n.scope)}).catch(function(n){console.log("Service Worker registro fallo: ",n)});const{host:v}=window.location,Se="Vcard",Le="firebase",p="#/",W="src/",x=W+"pages/",qe="vite",f="localhost:5173",h="localhost",L=v==f||v==h?"http://localhost/MisSitios/apirestm/api":"https://apirestm.000webhostapp.com/api",Ie=L+"/v2/api_version";console.log(v+"=="+f,v+"=="+h);console.warn("Api="+L);const Ae=`<div class="container text-center">\r
    <div class="row">\r
...
`,ze=n=>{var e=G[n];return e=e??We,sn(e)},O=async n=>{try{const e=await fetch(n);if(e.status==200){const t=await e.json();if(t)return t}else console.log("Error 404")}catch(e){console.log(e)}},{hash:Tn,host:Ge,hostDev:Je,typeBack:Ke,apiVer:Ye}=m();function Qe(){var n=self.location.href,e=n.lastIndexOf("/"),t=n.substring(e+1,n.length);return t}function Xe(n,e){var t=n.replace("/"+e,""),r=t.split("/"),s=window.location.search.substring(1),o=s.split("&");return s==""&&(o=["mod="+r[1],"ext="+r[2],"id="+r[3]]),o}function Ze(n){for(var e=0;e<n.length;e++){var t=n[e].split("=");if(t[0]=="mod")var r=t[1];if(t[0]=="ext")var s=t[1];if(t[0]=="id")var o=t[1]}return r=r==""?"Home":r.replace("?",""),s=s==""||s=="undefined"?"index":s,o=o==""||o=="undefined"?"":o,{mod:r,ext:s,id:o}}function _e(n,e,t,r){let s=localStorage.getItem("Token");document.querySelector("#menuweb");let o=document.querySelector(".user-login"),a=document.querySelector(".user-activo"),l=document.querySelector(".user-logout");t[e]&&(o.classList.remove("d-none"),a.classList.add("d-none"),l.classList.add("d-none"),s!=null&&s!=null&&s!="null"&&s!="undefined"&&(o.classList.add("d-none"),a.classList.remove("d-none"),l.classList.remove("d-none")))}const en=(n,e,t,r)=>{localStorage.getItem("Token"),i("log","hash=>"+n);let s=t!="index"?" / "+H(t):"";document.title=r+" - "+H(e)+s,nn(e,Ue);let o=e!="Home"&&t!="index"?t:e,a=document.getElementById("app");if(a&&(a.innerHTML="",n))return a.appendChild(ze(o))};function nn(n,e){var t=localStorage.getItem("Token");i("log","token="+t);let r=e.length;for(let s=0;s<r;s++)n===e[s]&&i("log","Accceso: "+n+"="+e[s]),n===e[s]&&(t==null||t=="undefined")&&(window.location.href="#/noauth");n=="login"&&t!=null&&t!="undefined"&&(window.location.href="#/dashboard")}function sn(n){const e=document.createElement("div");return e.innerHTML=n,e}function tn(n,e){(n==""||n=="undefined")&&(window.location.href=e)}function i(n,e){if(Ge==Je)switch(n){case"log":console.log(e);break;case"warn":console.warn(e);break;case"error":console.error(e);break;default:console.log(e);break}}function H(n){return n[0].toUpperCase()+n.slice(1).toLowerCase()}function M(n,e){if(n.length>0)for(let s=0;s<n.length;s++){let o=document.getElementById(e+s);if(console.log(e+s),o)i("log","Ok: "+e+"-"+s);else if(i("log",n[s]),document.createStyleSheet)document.createStyleSheet(n[s]);else{var t="@import url('"+n[s]+"');",r=document.createElement("link");r.id=e+s,r.rel="stylesheet",r.href="data:text/css,"+escape(t),document.getElementsByTagName("head")[0].appendChild(r)}}}function $(n,e){if(n.length>0)for(let r=0;r<n.length;r++)if(document.getElementById(e+r))i("log","Ok: "+e+r);else{i("log",n[r]);var t=document.createElement("script");t.id=e+r,t.src=n[r],document.body.appendChild(t)}}function V(n,e){for(let t=0;t<=n.length;t++){let r=document.getElementById(e+t);r&&document.body.removeChild(r)}}function U(n,e){for(let t=0;t<n.length;t++){let r=document.getElementById(e+t);r&&document.getElementsByTagName("head")[0].removeChild(r)}}function rn(){let n=document.getElementsByTagName("body")[0],t=`<div class="layerLoading">
    <img src="./assets/img/loader-green.gif" alt=""/>
    <p>Cargando...</p>
  </div>`;var r=document.createElement("div");r.id="load",r.innerHTML=t,n.appendChild(r),setTimeout(()=>{let s=document.getElementById(r.id);s&&n.removeChild(s)},5e3)}function on(){const{mod:n,ext:e}=m();let t=n!="Home"&&e!="index"?e:n;var r=G[t];n!="logout"&&n!="noauth"&&e=="index"&&r!=null&&rn()}async function an(n,e){if(Ke!="firebase"){if(n=="Home"){const{version:t}=await O(`${e}assets/pwa/manifest.json`);console.log(`Version Actual: ${t}`);const r=await O(Ye);if(r&&r!=null){const{ultimate:s}=r.data[0];t!=s&&console.log(`Actualizar version ${n} (${t} => ${s})`)}else console.warn("No se pudo llevar a cabo la comprobación de versiones")}}else console.warn("Only Firebase")}const ln=m(),{host:cn,dominio:dn,path_url:mn,hostDev:gn,typeBack:pn}=ln;console.log("/* javascript login | VARIABLES CONSTANTES*/");let q=L+"/login/";cn==gn&&pn!="firebase"&&console.log("api_login="+q);function un(){const n=document.getElementById("form-login");n!=null&&(n.addEventListener("submit",vn),console.log("btnLogin Activado"))}function vn(n){n.preventDefault(),console.log("Validación de Datos");let e=document.getElementById("username").value,t=document.getElementById("password").value;var r={username:e,password:t};const s=q+"index.php";fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}).then(o=>o.json()).then(o=>{const{data:a}=o;i("log",o),i("log","getToken:"+a.token),localStorage.setItem("Token",a.token);let l=localStorage.getItem("Token");if(i("log","Res-Token:"+l),l!=null&&l!="undefined")location.href=dn+mn+"#/dashboard";else{let b=document.getElementById("msj-error");b.innerHTML='<div class="alert alert-danger" role="alert">Usuario o Contraseña Incorrectos</div>'}}).catch(o=>{console.log(o);let a=document.getElementById("msj-error");a.innerHTML='<div class="alert alert-danger" role="alert">Error:Usuario o Contraseña Incorrectos</div>'})}const fn=()=>{const n=q+"";fetch(n).then(e=>e.json()).then(e=>{i("log",e)}).catch(e=>console.log(e)),setTimeout(function(){un()},1e3)};function hn(){console.log("Logout/Salir"),localStorage.clear();var n=localStorage.getItem("Token");n==null&&(console.warn("TOKEN CLEAR"),setTimeout(function(){window.location.href="#/"},3e3))}m();function bn(n){let e=document.querySelector(".body");e&&(n!=""&&n!="Home"?e.style.display="none":e.style.display="inherit")}function yn(n,e){const t=["https://fonts.googleapis.com/css?family=Muli:300,400,700","https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css",e+"assets/login/vendor/bootstrap/css/bootstrap.min.css",e+"assets/login/vendor/font-awesome/css/font-awesome.min.css",e+"assets/login/css/font.css",e+"assets/login/css/style.green.css",e+"assets/login/css/custom.css"],r=[e+"assets/login/vendor/popper.js/umd/popper.min.js",e+"assets/login/vendor/bootstrap/js/bootstrap.min.js",e+"assets/login/vendor/bootstrap/js/bootstrap-colorpicker.min.js",e+"assets/login/vendor/jquery.cookie/jquery.cookie.js",e+"assets/login/vendor/chart.js/Chart.min.js",e+"assets/login/vendor/jquery-validation/jquery.validate.min.js","https://cdn.jsdelivr.net/npm/sweetalert2@9.14.4/dist/sweetalert2.all.min.js","https://cdn.jsdelivr.net/npm/toastify-js",e+"assets/login/js/front.js"];n!="app"?(U(t,"appCS-"),V(r,"appJS-")):(M(t,"appCS-"),$(r,"appJS-"));const s=["https://fonts.googleapis.com/css?family=Playfair+Display:400,700%7CSintony:400,700",e+"assets/tema/css/bootstrap.min.css",e+"assets/tema/css/all.min.css",e+"assets/tema/css/animate.min.css",e+"assets/tema/css/simple-line-icons.min.css",e+"assets/tema/css/owl.carousel.min.css",e+"assets/tema/css/owl.theme.default.min.css",e+"assets/tema/css/magnific-popup.min.css",e+"assets/tema/css/theme.css",e+"assets/tema/css/theme-elements.css",e+"assets/tema/css/theme-blog.css",e+"assets/tema/css/theme-shop.css",e+"assets/tema/css/settings.css",e+"assets/tema/css/layers.css",e+"assets/tema/css/navigation.css",e+"assets/tema/css/demo-business-consulting.css",e+"assets/tema/css/skin-business-consulting.css",e+"assets/tema/css/style.css",e+"assets/font-awesome-4.7.0/css/font-awesome.css"],o=[e+"assets/tema/js/jquery.appear.min.js",e+"assets/tema/js/jquery.easing.min.js",e+"assets/tema/js/jquery.cookie.min.js",e+"assets/tema/js/popper.min.js",e+"assets/tema/js/bootstrap.min.js",e+"assets/tema/js/common.min.js",e+"assets/tema/js/jquery.validate.min.js",e+"assets/tema/js/jquery.easypiechart.min.js",e+"assets/tema/js/jquery.gmap.min.js",e+"assets/tema/js/jquery.lazyload.min.js",e+"assets/tema/js/jquery.isotope.min.js",e+"assets/tema/js/owl.carousel.min.js",e+"assets/tema/js/jquery.magnific-popup.min.js",e+"assets/tema/js/jquery.vide.min.js",e+"assets/tema/js/vivus.min.js",e+"assets/tema/js/theme.js",e+"assets/tema/js/jquery.themepunch.tools.min.js",e+"assets/tema/js/jquery.themepunch.revolution.min.js",e+"assets/tema/js/demo-business-consulting.js",e+"assets/tema/js/custom.js",e+"assets/tema/js/theme.init.js"];n!="Home"?(U(s,"homeCS-"),V(o,"homeJS-")):(M(s,"homeCS-"),$(o,"homeJS-"))}console.log("Firebase SDK");var jn={apiKey:"AIzaSyDeX81H_K8AsV2KjQgEbwxte6yVdSYqFXk",authDomain:"vcardapp-js.firebaseapp.com",databaseURL:"https://vcardapp-js.firebaseio.com",projectId:"vcardapp-js",storageBucket:"vcardapp-js.appspot.com",messagingSenderId:"420720513571",appId:"1:420720513571:web:f072eeda6cd3cfa1429796",measurementId:"G-LDPZ4BZ1GV"};const I=he(jn),A=ge(I),kn=ye(I);be(I);function wn(n){console.log("saveUser");var e={uid:n.uid,usuario:n.displayName,email:n.email,foto:n.photoURL};je(ke(kn,"vcard_signup/"+n.uid),e)}document.querySelectorAll(".logged-out");document.querySelectorAll(".logged-in");const F=n=>{console.log("loginCheck"),document.querySelector("#logout-1");const e=document.querySelector("#btnRegis"),t=document.querySelector("#btnLogin"),r=document.querySelector(".registro-page"),s=document.querySelector(".login-page"),o=document.querySelector(".dashboard");n?(s.style.display="none",r.style.display="none",o.style.display="block"):(s.style.display="block",o.style.display="none",e&&e.addEventListener("click",()=>{r.style.display="block",s.style.display="none"}),t&&t.addEventListener("click",()=>{r.style.display="none",s.style.display="block"}))};function J(n,e){Toastify({text:n,duration:3e3,destination:"https://github.com/apvarun/toastify-js",newWindow:!0,close:!0,gravity:"bottom",position:"right",stopOnFocus:!0,style:{background:e==="success"?"green":e==="warning"?"orange":e==="info"?"blue":"red"},onClick:function(){}}).showToast()}function xn(){const n=document.querySelector("#googleLogin");n&&n.addEventListener("click",async e=>{e.preventDefault();const t=new pe;try{const r=await ue(A,t);console.log("google sign in"),J("Welcome "+r.user.displayName,"success")}catch(r){console.log(r)}})}function Sn(){const n=document.querySelector("#logout");n&&n.addEventListener("click",async e=>{e.preventDefault();try{await ve(A),localStorage.clear(),console.log("signup out"),J("Signup out","info")}catch(t){console.log(t)}})}function Ln(){console.log("Cargando App..."),xn(),Sn(),fe(A,async n=>{if(n){i("log",n),F(n);try{wn(n)}catch(e){console.log(e)}}else F(n)})}const qn=()=>{Ln()};function In(n){const{route:e,mod:t,id:r,base_url:s}=n;i("log","route="+e),on(),t&&(bn(t),yn(t,s)),e=="app/index"&&qn(),e=="login/index"&&fn(),e=="logout/index"&&hn()}function m(){var n=window,e=document,t=n.location,r=new Date,s=r.getDate();s=s<10?"0"+s:s;var o=r.getMonth()+1;o=o<10?"0"+o:o;var a=r.getFullYear(),l=a+"-"+o+"-"+s;const{protocol:b,host:c,origin:E,pathname:C,hash:R,href:Y,search:Q}=t,y=E+"/",X=E,Z=Y,_=Q,j=C.replace("/",""),k=y+j,B=c=="localhost"||c!=f&&c!=h?j+p:p,ee=c=="localhost:9001"?"../":"./",ne=y+B,se=screen.width,te=screen.height;var P="default",re="temas/"+P+"/",oe=Qe(),T=Xe(R,p);let{mod:g,ext:d,id:ae}=Ze(T);var D="/"+d,N=g+D,ie=g||"",le=d&&d!="index"?"/"+d:"",ce="#/"+ie+le,de=k+x+N+".html",me=k+x+"404/index.html";return{w:n,d:e,loc:t,dt:r,day:s,mon:o,year:a,fecha:l,title:Se,typeBack:Le,typeDev:qe,path_hash:p,path_src:W,path_page:x,hostDev:f,hostPre:h,protocol:b,host:c,dominio:y,dominio1:X,pathname:C,hash:R,URL:Z,quest:_,path_url:j,path_root:B,path_build:ee,base_url:k,page_url:ne,screenw:se,screenh:te,tema:P,path_tema:re,pag_name:oe,vars_Url:T,mod:g,ext:d,id:ae,ext2:D,route:N,hash2:ce,url_mod:de,url404:me,apiVer:Ie}}function K(){const n=m();i("log",n);const{hash:e,mod:t,ext:r,page_url:s,base_url:o,title:a}=n;en(e,t,r,a),In(n),_e(e,t,z),tn(t,s),an(t,o)}function An(){console.log("Run function inicio"),K()}window.addEventListener("hashchange",()=>{i("warn","Event Listener"),K()});An();
