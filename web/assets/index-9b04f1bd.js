(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();let ve=window.location;const{pathname:ge,host:H}=ve;H!=="localhost"&&H!=="localhost:5173"&&H!=="127.0.0.1:5173"&&"serviceWorker"in navigator&&navigator.serviceWorker.register(ge+"sw.js").then(function(e){console.log("Service Worker registro correcto con scope: ",e.scope)}).catch(function(e){console.log("Service Worker registro fallo: ",e)});const{host:B}=window.location,me="VcardApp",fe="firebase",T="#/",ee="src/",N=ee+"pages/",he="vite",O="localhost:5173",M="localhost";console.log(B+"=="+O,B+"=="+M);const U=B==O||B==M?"http://localhost/MisSitios/apirestm/api":"https://apirestm.000webhostapp.com/api";console.warn("Api="+U);const be=U+"/v2/api_version",ye=`<div id="appDash">\r
<!-- ============================================================== -->\r
...
\r
    <!-- Right bar overlay-->\r
    <div class="rightbar-overlay"></div>`,K=`            <!-- ========== Left Sidebar Start ========== -->\r
...
\r
            ...
            <!-- Left Sidebar End -->`,X=`          <!-- Topbar Start -->\r
...
</div>`,te={Home:De},Pe={dashboard:'<!-- Begin page --><div id="wrapper">'+X+K+'<div class="content-page">'+ye+Q+"</div></div><!-- END wrapper -->"+W,app:'<!-- Begin page --><div id="wrapper" class="dashboard" style="display: none;">'+X+K+'<div class="content-page">'+we+Q+"</div></div><!-- END wrapper -->"+W+xe+ke,tarjetas:qe,empresas:je,cuenta:Ee,settings:Se,forget:$e,login:Ce,logout:Ie,registro:_e,noauth:Le},ne={...te,...Pe},Te=["dashboard","tarjetas","empresas","cuenta","settings"],Ae=`<div class="text-center">\r
...
`,Re=e=>{var t=ne[e];return t=t??Ae,Ke(t)},Be=async(e,t,n,r)=>{const a=`${e}/${t}`;let o=localStorage.getItem("Token");o=o&&o!=null?o:"";const c={...r,token:o},p=r!=null?JSON.stringify(c):"",u=await fetch(a,{method:n,headers:{"Content-Type":"application/json"},body:p});if(!u.ok)console.error("Error 404(Fetch): "),u=="Unauthorized"?console.error("Error 401(Fetch): "):u=="Forbidden"?console.error("Error 403(Fetch): "):u=="Not Found"&&console.error("Error 404(Fetch): ");else return await u.json()},Oe=async(e,t)=>{const{data:n}=await Be(e,"profile/index.php","POST","");switch(t){case"InfoUser":return n.InfoUser;case"InfoToken":return n.InfoToken;default:return n}},Y=async e=>{try{const t=await fetch(e);if(t.status==200){const n=await t.json();if(n)return n}else console.log("Error 404")}catch(t){console.log(t)}},{host:Me,hostDev:Ue,typeBack:Ct,apiVer:Fe}=L();function He(){var e=self.location.href,t=e.lastIndexOf("/"),n=e.substring(t+1,e.length);return n}function Ne(e,t){var n=e.replace("/"+t,""),r=n.split("/"),a=window.location.search.substring(1),o=a.split("&");return a==""&&(o=["mod="+r[1],"ext="+r[2],"id="+r[3]]),o}function Ve(e){for(var t=0;t<e.length;t++){var n=e[t].split("=");if(n[0]=="mod")var r=n[1];if(n[0]=="ext")var a=n[1];if(n[0]=="id")var o=n[1]}return r=r==""?"Home":r.replace("?",""),a=a==""||a=="undefined"?"index":a,o=o==""||o=="undefined"?"":o,{mod:r,ext:a,id:o}}function ze(e,t,n,r){let a=localStorage.getItem("Token");document.querySelector("#menuweb");let o=document.querySelector(".user-login"),c=document.querySelector(".user-activo"),p=document.querySelector(".user-logout");n[t]&&(o.classList.remove("d-none"),c.classList.add("d-none"),p.classList.add("d-none"),a!=null&&a!=null&&a!="null"&&a!="undefined"&&(o.classList.add("d-none"),c.classList.remove("d-none"),p.classList.remove("d-none")))}const Ge=(e,t,n,r)=>{localStorage.getItem("Token"),x("log","hash=>"+e);let a=n!="index"?" / "+J(n):"";document.title=r+" - "+J(t)+a,We(t,Te);let o=t!="Home"&&n!="index"?n:t,c=document.getElementById("app");if(c.innerHTML="",e)return c.appendChild(Re(o))};function We(e,t){var n=localStorage.getItem("Token");x("log","token="+n);let r=t.length;for(let a=0;a<r;a++)e===t[a]&&x("log","Accceso: "+e+"="+t[a]),e===t[a]&&(n==null||n=="undefined")&&(window.location.href="#/noauth");e=="login"&&n!=null&&n!="undefined"&&(window.location.href="#/dashboard")}function Ke(e){const t=document.createElement("div");return t.innerHTML=e,t}function Xe(e,t){(e==""||e=="undefined")&&(window.location.href=t)}function x(e,t){if(Me==Ue)switch(e){case"log":console.log(t);break;case"warn":console.warn(t);break;case"error":console.error(t);break;default:console.log(t);break}}function J(e){return e[0].toUpperCase()+e.slice(1).toLowerCase()}function A(e,t){if(e.length>0)for(let a=0;a<e.length;a++)if(document.getElementById(t+a))x("log","Ok: dash-"+a);else if(document.createStyleSheet)document.createStyleSheet(e[a]);else{var n="@import url('"+e[a]+"');",r=document.createElement("link");r.id=t+a,r.rel="stylesheet",r.href="data:text/css,"+escape(n),document.getElementsByTagName("head")[0].appendChild(r)}}function R(e,t){for(let n=0;n<e;n++){let r=document.getElementById(t+n);r&&document.getElementsByTagName("head")[0].removeChild(r)}}function Qe(){let e=document.getElementsByTagName("body")[0],n=`<div class="layerLoading">
    <img src="./assets/img/loader-green.gif" alt=""/>
    <p>Cargando...</p>
  </div>`;var r=document.createElement("div");r.id="load",r.innerHTML=n,e.appendChild(r),setTimeout(()=>{let a=document.getElementById(r.id);a&&e.removeChild(a)},1500)}function Ye(){const{mod:e,ext:t}=L();let n=e!="Home"&&t!="index"?t:e;var r=ne[n];e!="logout"&&e!="noauth"&&t=="index"&&r!=null&&Qe()}async function Je(e,t){if(e=="Home"){const{version:n}=await Y(`${t}assets/pwa/manifest.json`);console.log(`Version Actual: ${n}`);const r=await Y(Fe);if(r&&r!=null){const{ultimate:a}=r.data[0];n!=a&&console.log(`Actualizar version ${e} (${n} => ${a})`)}else console.warn("No se pudo llevar a cabo la comprobación de versiones")}}const{host:Ze,dominio:et,path_url:tt,hostDev:nt}=L();console.log("/* javascript login | VARIABLES CONSTANTES*/");let V=U+"/login/";Ze==nt&&console.log("api_login="+V);function rt(){const e=document.getElementById("form-login");e!=null&&(e.addEventListener("submit",at),console.log("btnLogin Activado"))}function at(e){e.preventDefault(),console.log("Validación de Datos");let t=document.getElementById("username").value,n=document.getElementById("password").value;var r={username:t,password:n};const a=V+"index.php";fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}).then(o=>o.json()).then(o=>{const{data:c}=o;x("log",o),x("log","getToken:"+c.token),localStorage.setItem("Token",c.token);let p=localStorage.getItem("Token");x("log","Res-Token:"+p),p!=null&&p!="undefined"?location.href=et+tt+"#/dashboard":Z(!1,0)}).catch(o=>{Z(o,1)})}const Z=(e,t)=>{e&&console.log(e);let n=document.getElementById("msj-error");n.innerHTML=`<div class="alert alert-danger" role="alert">${t==1?"<b>Error:</b>":""} Usuario o Contraseña Incorrectos</div>`},ot=()=>{const e=V+"";fetch(e).then(t=>t.json()).then(t=>{x("log",t)}).catch(t=>console.log(t)),setTimeout(function(){rt()},1e3)};function st(){console.log("Logout/Salir"),localStorage.clear();var e=localStorage.getItem("Token");e==null&&(console.warn("TOKEN CLEAR"),setTimeout(function(){window.location.href="#/"},3e3))}function re(){(function(e){var t=function(){};t.prototype.initTooltipPlugin=function(){e.fn.tooltip&&e('[data-toggle="tooltip"]').tooltip()},t.prototype.initPopoverPlugin=function(){e.fn.popover&&e('[data-toggle="popover"]').popover()},t.prototype.initToastPlugin=function(){e.fn.toast&&e('[data-toggle="toast"]').toast()},t.prototype.initSlimScrollPlugin=function(){e.fn.slimScroll&&e(".slimscroll").slimScroll({height:"auto",position:"right",size:"8px",touchScrollStep:20,color:"#9ea5ab"})},t.prototype.initFormValidation=function(){e(".needs-validation").on("submit",function(n){return e(this).addClass("was-validated"),e(this)[0].checkValidity()===!1?(n.preventDefault(),n.stopPropagation(),!1):!0})},t.prototype.initCustomModalPlugin=function(){e('[data-plugin="custommodal"]').on("click",function(n){n.preventDefault();var r=new Custombox.modal({content:{target:e(this).attr("href"),effect:e(this).attr("data-animation")},overlay:{color:e(this).attr("data-overlayColor")}});r.open()})},t.prototype.initCounterUp=function(){e(this).attr("data-delay")&&e(this).attr("data-delay"),e(this).attr("data-time")&&e(this).attr("data-time"),e('[data-plugin="counterup"]').each(function(n,r){e(this).counterUp({delay:100,time:1200})})},t.prototype.initPeityCharts=function(){e('[data-plugin="peity-pie"]').each(function(n,r){var a=e(this).attr("data-colors")?e(this).attr("data-colors").split(","):[],o=e(this).attr("data-width")?e(this).attr("data-width"):20,c=e(this).attr("data-height")?e(this).attr("data-height"):20;e(this).peity("pie",{fill:a,width:o,height:c})}),e('[data-plugin="peity-donut"]').each(function(n,r){var a=e(this).attr("data-colors")?e(this).attr("data-colors").split(","):[],o=e(this).attr("data-width")?e(this).attr("data-width"):20,c=e(this).attr("data-height")?e(this).attr("data-height"):20;e(this).peity("donut",{fill:a,width:o,height:c})}),e('[data-plugin="peity-donut-alt"]').each(function(n,r){e(this).peity("donut")}),e('[data-plugin="peity-line"]').each(function(n,r){e(this).peity("line",e(this).data())}),e('[data-plugin="peity-bar"]').each(function(n,r){var a=e(this).attr("data-colors")?e(this).attr("data-colors").split(","):[],o=e(this).attr("data-width")?e(this).attr("data-width"):20,c=e(this).attr("data-height")?e(this).attr("data-height"):20;e(this).peity("bar",{fill:a,width:o,height:c})})},t.prototype.initKnob=function(){e('[data-plugin="knob"]').each(function(n,r){e(this).knob()})},t.prototype.initTippyTooltips=function(){e('[data-plugin="tippy"]').length>0&&tippy('[data-plugin="tippy"]')},t.prototype.init=function(){this.initTooltipPlugin(),this.initPopoverPlugin(),this.initToastPlugin(),this.initSlimScrollPlugin(),this.initFormValidation(),this.initCustomModalPlugin(),this.initCounterUp(),this.initPeityCharts(),this.initKnob(),this.initTippyTooltips()},e.Components=new t,e.Components.Constructor=t})(window.jQuery),function(e){var t=function(){this.$body=e("body"),this.$portletIdentifier=".card",this.$portletCloser='.card a[data-toggle="remove"]',this.$portletRefresher='.card a[data-toggle="reload"]'};t.prototype.init=function(){var n=this;e(document).on("click",this.$portletCloser,function(r){r.preventDefault();var a=e(this).closest(n.$portletIdentifier),o=a.parent();a.remove(),o.children().length==0&&o.remove()}),e(document).on("click",this.$portletRefresher,function(r){r.preventDefault();var a=e(this).closest(n.$portletIdentifier);a.append('<div class="card-disabled"><div class="card-portlets-loader"></div></div>');var o=a.find(".card-disabled");setTimeout(function(){o.fadeOut("fast",function(){o.remove()})},500+300*(Math.random()*5))})},e.Portlet=new t,e.Portlet.Constructor=t}(window.jQuery),function(e){var t=function(){this.$body=e("body"),this.$window=e(window)};t.prototype._resetSidebarScroll=function(){e(".slimscroll-menu").slimscroll({height:"auto",position:"right",size:"8px",color:"#9ea5ab",wheelStep:5,touchScrollStep:20})},t.prototype.initMenu=function(){var n=this;e(".button-menu-mobile").on("click",function(r){r.preventDefault(),n.$body.toggleClass("sidebar-enable"),n.$window.width()>=768?n.$body.toggleClass("enlarged"):n.$body.removeClass("enlarged"),n._resetSidebarScroll()}),e("#side-menu").metisMenu(),n._resetSidebarScroll(),e(".right-bar-toggle").on("click",function(r){e("body").toggleClass("right-bar-enabled")}),e(document).on("click","body",function(r){e(r.target).closest(".right-bar-toggle, .right-bar").length>0||e(r.target).closest(".left-side-menu, .side-nav").length>0||e(r.target).hasClass("button-menu-mobile")||e(r.target).closest(".button-menu-mobile").length>0||(e("body").removeClass("right-bar-enabled"),e("body").removeClass("sidebar-enable"))}),e("#side-menu a").each(function(){var r=window.location.href.split(/[?#]/)[0];this.href==r&&(e(this).addClass("active"),e(this).parent().addClass("active"),e(this).parent().parent().addClass("in"),e(this).parent().parent().prev().addClass("active"),e(this).parent().parent().parent().addClass("active"),e(this).parent().parent().parent().parent().addClass("in"),e(this).parent().parent().parent().parent().parent().addClass("active"))}),e(".navbar-toggle").on("click",function(r){e(this).toggleClass("open"),e("#navigation").slideToggle(400)}),e(window).on("load",function(){e("#status").fadeOut(),e("#preloader").delay(350).fadeOut("slow")})},t.prototype.initLayout=function(){this.$window.width()>=768&&this.$window.width()<=1028?this.$body.addClass("enlarged"):this.$body.data("keep-enlarged")!=!0&&this.$body.removeClass("enlarged")},t.prototype.init=function(){var n=this;this.initLayout(),e.Portlet.init(),this.initMenu(),e.Components.init(),n.$window.on("resize",function(r){r.preventDefault(),n.initLayout(),n._resetSidebarScroll()})},e.App=new t,e.App.Constructor=t}(window.jQuery),function(e){e.App.init()}(window.jQuery),Waves.init()}const it=L(),{host:ae,dominio:It,path_url:_t,base_url:Lt,screenw:lt,mod:Et,hostDev:oe,year:ct}=it;async function dt(){re();let e=document.querySelector(".log-out");e!=null&&e.addEventListener("click",()=>{setTimeout(()=>{window.location.href="#/logout"},1e3)});let t=document.querySelector(".btn-set");t!=null&&t.addEventListener("click",()=>{window.location.href="#/dashboard/settings"});let n=document.querySelector(".user-edit");n!=null&&n.addEventListener("click",()=>{window.location.href="#/dashboard/cuenta"});let r=document.querySelector("#year");r&&(r.innerHTML=ct+" &copy; Xeria theme");let a=document.querySelectorAll(".arrow");for(var o=0;o<a.length;o++)a[o].addEventListener("click",v=>{v.target.parentElement.parentElement.classList.toggle("showMenu")});let c=document.querySelector(".sidebar"),p=document.querySelector(".bx-menu");if(p){let v=localStorage.getItem("bar");v=="true"&&c.classList.toggle("close"),p.addEventListener("click",()=>{let g=c.classList.toggle("close");localStorage.setItem("bar",g),v=localStorage.getItem("bar")}),console.log("Bar-Load:",v)}lt<=740&&c&&side.classList.add("close");const m=document.querySelector(".profile_name"),u=document.querySelector(".pro-user-name"),k=document.querySelector(".job");let q=ae==oe?": DASHBOARD-GET PROFILE":"";if(console.log("AUTORIZADO"+q),m!=null&&k!=null&&u!=null){const{email:v,username:g,nombre:F,foto:D,puesto:E,status:P}=await Oe(U,"InfoUser");m&&(m.innerHTML=g),u&&(u.innerHTML=g+' <i class="mdi mdi-chevron-down"></i>'),k&&(k.innerHTML=E)}setTimeout(()=>{let v=document.querySelector(".slimscroll-menu");v&&(v.style.height="350px");let g=document.querySelector("#slimscroll-menu");g&&(g.style.height="250px")},100)}function ut(){setTimeout(function(){ae==oe&&console.log("btnSidebar Activado"),dt()},500)}function pt(e,t){const n="app-",r=[t+"assets/dashboard/xeria/assets/css/bootstrap.css",t+"assets/dashboard/xeria/assets/css/app.css","https://fonts.googleapis.com/css?family=Muli:300,400,700",t+"assets/login/vendor/bootstrap/css/bootstrap.min.css",t+"assets/login/css/font.css",t+"assets/login/css/style.green.css",t+"assets/login/css/custom.css"];e=="app"?A(r,n):R(r.length,n);const a="dash-",o=[t+"assets/dashboard/xeria/assets/css/bootstrap.css",t+"assets/dashboard/xeria/assets/css/app.css"];e=="dashboard"?A(o,a):R(o.length,a);const c="login-",p=["https://fonts.googleapis.com/css?family=Muli:300,400,700",t+"assets/login/vendor/bootstrap/css/bootstrap.min.css",t+"assets/login/css/font.css",t+"assets/login/css/style.green.css",t+"assets/login/css/custom.css"];e!="login"&&e!="registro"?R(p.length,c):A(p,c);const m="home-",u=[t+"assets/tema/css/demo-business-consulting.css",t+"assets/tema/css/skin-business-consulting.css",t+"assets/tema/css/style.css"];e!="Home"?R(u.length,m):A(u,m)}function vt(){const{mod:e}=L();var t={apiKey:"AIzaSyDeX81H_K8AsV2KjQgEbwxte6yVdSYqFXk",authDomain:"vcardapp-js.firebaseapp.com",databaseURL:"https://vcardapp-js.firebaseio.com",projectId:"vcardapp-js",storageBucket:"vcardapp-js.appspot.com",messagingSenderId:"420720513571",appId:"1:420720513571:web:f072eeda6cd3cfa1429796",measurementId:"G-LDPZ4BZ1GV"};firebase.initializeApp(t),firebase.analytics();const n=firebase.database(),r=firebase.auth();firebase.firestore(),console.log("Modulo=>"+e),n.ref().child("vcard_config"),n.ref().child("vcard_signup");var a=n.ref().child("vcard_vcard"),o=n.ref().child("vcard_user"),c=n.ref().child("vcard_vcard_empresas");const p=document.querySelectorAll(".dashboard"),m=document.querySelectorAll(".login-page"),u=document.querySelectorAll(".registro-page"),k=i=>{i?(p.forEach(s=>s.style.display="block"),m.forEach(s=>s.style.display="none"),u.forEach(s=>s.style.display="none")):(p.forEach(s=>s.style.display="none"),e=="registro"?(u.forEach(s=>s.style.display="block"),m.forEach(s=>s.style.display="none")):(u.forEach(s=>s.style.display="none"),m.forEach(s=>s.style.display="block")))};document.querySelector("#logout").addEventListener("click",i=>{i.preventDefault(),r.signOut().then(()=>{console.log("signup out"),localStorage.clear(),navigator.serviceWorker.getRegistrations().then(function(s){for(let l of s)l.unregister()})})});const v=document.querySelector("#registro-form");v.addEventListener("submit",i=>{i.preventDefault();const s="Sin Nombre",l=v["register-email"].value,d=v["register-password"].value;var f={displayName:s,email:l,photoURL:null};r.createUserWithEmailAndPassword(l,d).then(h=>{console.log("Datos user: "+f),v.reset()})});const g=document.querySelector("#form-login");g.addEventListener("submit",i=>{i.preventDefault();const s=g["login-email"].value,l=g["login-password"].value;r.signInWithEmailAndPassword(s,l).then(d=>{g.reset()})}),r.onAuthStateChanged(i=>{i?(console.log("signin:"+i.email),k(i)):(console.log("signout"),k(i))}),document.querySelector("#googleLogin").addEventListener("click",i=>{i.preventDefault(),g.reset(),E()}),document.querySelector("#googleRegister").addEventListener("click",i=>{i.preventDefault(),g.reset(),E()});function E(){const i=new firebase.auth.GoogleAuthProvider;r.signInWithPopup(i).then(s=>{console.log(s),console.log("google sign in")}).catch(s=>{console.log(s)})}function P(){var i="";a.orderByChild("orden").limitToFirst(10).on("child_added",function(l){var d=l.val();const{ID:f,cover:h,profile:b,nombre:w,puesto:_,f_create:S,visible:I}=d;if(I==1){i+=`
