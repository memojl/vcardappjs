...
</nav>`,cn=["dashboard","settings","perfil","tarjetas","empresas"],pn={forget:Vr,login:Wr,logout:Jr,noauth:Yr,registro:zr,dashboard:Kr,settings:Qr,perfil:Zr,tarjetas:Xr,empresas:rn},yr={Home:nn,app:an,vcard:en,profile:sn,nosotros:O+tn,productos:O+on,categorias:O+ln,contacto:O+dn},kr={...yr,...pn},cr=[{txt:"Dashboard",icon:"icon-dashboard",link:"/#/app"},{txt:"Dashboard",icon:"icon-dashboard",link:"/#/dashboard"},{txt:"Perfil",icon:"fa fa-user",link:"/#/app/perfil"},{txt:"Mis tarjetas",icon:"fa fa-vcard",link:"/#/app/tarjetas"},{txt:"Mis empresas",icon:"fa fa-industry",link:"/#/app/empresas"}],vn=`<div class="text-center">\r
...
`,mn=n=>{var r=kr[n];return r=r??vn,Ln(r)},{host:un,year:gn,hostDev:fn,typeBack:bn}=b();function hn(){var n=self.location.href,r=n.lastIndexOf("/"),s=n.substring(r+1,n.length);return s}function yn(n,r){var s=n.replace("/"+r,""),a=s.split("/"),e=window.location.search.substring(1),i=e.split("&");return e==""&&(i=["mod="+a[1],"ext="+a[2],"id="+a[3]]),i}function kn(n,r){const s=r?r.split("/"):n.split("/");console.log(s);var a=s[1]===""?"Home":s[1],e=s[2]===""||s[2]===void 0?"index":s[2],i=s[3]===""||s[3]===void 0?"":s[3];return{mod:a,ext:e,id:i}}function xn(n,r,s,a){let e=localStorage.getItem("Token");document.querySelector("#menuweb");let i=document.querySelector(".user-login"),t=document.querySelector(".user-activo"),l=document.querySelector(".user-logout");s[r]&&(i.classList.remove("d-none"),t.classList.add("d-none"),l.classList.add("d-none"),e!=null&&e!=null&&e!="null"&&e!="undefined"&&(i.classList.add("d-none"),t.classList.remove("d-none"),l.classList.remove("d-none")))}const wn=(n,r,s,a,e)=>{localStorage.getItem("Token"),m("log","hash=>"+n);let i=r=="vcard"?"":J(r),t=s!="index"?""+J(s):"",l=a!=""?" / "+J(a):"";document.title=e+" - "+i+t+l,In(r,cn);let c=r!="Home"&&s!="index"?s:r,o=document.getElementById("app");if(o)return o.innerHTML="",o.appendChild(mn(c))};function In(n,r){var s=localStorage.getItem("Token");m("log","token="+s);let a=r.length;for(let e=0;e<a;e++)n===r[e]&&m("log","Accceso: "+n+"="+r[e]),n===r[e]&&(s==null||s=="undefined")&&(window.location.href="#/noauth");n=="login"&&s!=null&&s!="undefined"&&(window.location.href="#/dashboard")}function Ln(n){const r=document.createElement("div");return r.innerHTML=n,r}function Sn(n,r){(n==""||n=="undefined")&&(window.location.href=r)}function m(n,r){if(un==fn)switch(n){case"log":console.log(r);break;case"warn":console.warn(r);break;case"error":console.error(r);break;default:console.log(r);break}}function J(n){return n[0].toUpperCase()+n.slice(1).toLowerCase()}function Y(n,r){if(n.length>0){for(let e=0;e<n.length;e++)if(!document.getElementById(r+e))if(document.createStyleSheet)document.createStyleSheet(n[e]);else{var s="@import url('"+n[e]+"');",a=document.createElement("link");a.id=r+e,a.rel="stylesheet",a.href="data:text/css,"+escape(s),document.getElementsByTagName("head")[0].appendChild(a)}}}function z(n,r){for(let s=0;s<n.length;s++){let a=document.getElementById(r+s);a&&document.getElementsByTagName("head")[0].removeChild(a)}}function pr(n,r,s){if(n.length>0)for(let e=0;e<n.length;e++){let i=document.getElementById(r+e);if(i&&document.body.removeChild(i),s=="load"&&!document.getElementById(r+e)){var a=document.createElement("script");a.id=r+e,a.src=n[e],document.body.appendChild(a)}}}function vr(n,r){if(n.length>0){for(let a=0;a<n.length;a++)if(!document.getElementById(r+a)){var s=document.createElement("script");s.id=r+a,s.src=n[a],document.body.appendChild(s)}}}function mr(n,r){for(let s=0;s<n.length;s++){let a=document.getElementById(r+s);a&&document.body.removeChild(a)}}function _n(){const n=document.querySelector("#footer_page");n&&(n.innerHTML=gn+' &copy; VcardAppJS V.3.0.1 (Vite - MandragoraJS). Diseñada por <a target="_blank" href="http://multiportal.com.mx">[:MULTIPORTAL:]</a>.')}function Pn(){let n=document.getElementsByTagName("body")[0],s=`<div class="layerLoading">
    <img src="./assets/img/loader-green.gif" alt=""/>
    <p>Cargando...</p>
  </div>`;var a=document.createElement("div");a.id="load",a.innerHTML=s,n.appendChild(a),setTimeout(()=>{let e=document.getElementById(a.id);e&&n.removeChild(e)},5e3)}function Tn(){const{mod:n,ext:r}=b();let s=n!="Home"&&r!="index"?r:n;var a=kr[s];n!="dashboard"&&bn=="firebase"&&n!="logout"&&n!="noauth"&&r=="index"&&a!=null&&Pn()}async function jn(n,r){console.warn("Only Firebase")}function An(n,r,s){setTimeout(()=>{const a=document.querySelector("#menuList");let e="";if(a){for(let i=0;i<cr.length;i++){const{txt:t,icon:l,link:c}=cr[i];if((s=="app"||s=="dashboard")&&c!="/#/app"){const o=c=="/"+n||t=="Dashboard"&&r=="app/index"?'class="active"':"";e+=`<li ${o}><a href="${c}"><i class="${l}"></i> ${t}</a></li>`}}a.innerHTML=e}},100)}const Rn=b(),{dominio:qn,path_url:Cn}=Rn;console.log("/* javascript login | VARIABLES CONSTANTES*/");let xr=I+"/login/";function En(){const n=document.getElementById("form-login");n!=null&&(n.addEventListener("submit",Dn),console.log("btnLogin Activado"))}function Dn(n){n.preventDefault(),console.log("Validación de Datos");let r=document.getElementById("username").value,s=document.getElementById("password").value;var a={username:r,password:s};const e=xr+"index.php";fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}).then(i=>i.json()).then(i=>{const{data:t}=i;m("log",i),m("log","getToken:"+t.token),localStorage.setItem("Token",t.token);let l=localStorage.getItem("Token");if(m("log","Res-Token:"+l),l!=null&&l!="undefined")location.href=qn+Cn+"#/dashboard";else{let c=document.getElementById("msj-error");c.innerHTML='<div class="alert alert-danger" role="alert">Usuario o Contraseña Incorrectos</div>'}}).catch(i=>{console.log(i);let t=document.getElementById("msj-error");t.innerHTML='<div class="alert alert-danger" role="alert">Error:Usuario o Contraseña Incorrectos</div>'})}const Nn=()=>{const n=xr+"";fetch(n).then(r=>r.json()).then(r=>{m("log",r)}).catch(r=>console.log(r)),setTimeout(function(){En()},1e3)};function On(){console.log("Logout/Salir"),localStorage.clear();var n=localStorage.getItem("Token");n==null&&(console.warn("TOKEN CLEAR"),setTimeout(function(){window.location.href="#/"},3e3))}function $n(n){let r=document.querySelector(".body");r&&(n!=""&&n!="Home"?r.style.display="none":r.style.display="inherit")}function Mn(n,r){const s=["https://fonts.googleapis.com/css?family=Muli:300,400,700","https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css",r+"assets/login/vendor/bootstrap/css/bootstrap.min.css",r+"assets/login/vendor/font-awesome/css/font-awesome.min.css",r+"assets/login/css/font.css",r+"assets/login/css/style.green.css",r+"assets/login/css/custom.css"],a=[r+"assets/login/vendor/popper.js/umd/popper.min.js",r+"assets/login/vendor/bootstrap/js/bootstrap.min.js",r+"assets/login/vendor/bootstrap/js/bootstrap-colorpicker.min.js",r+"assets/login/vendor/jquery.cookie/jquery.cookie.js",r+"assets/login/vendor/chart.js/Chart.min.js",r+"assets/login/vendor/jquery-validation/jquery.validate.min.js","https://cdn.jsdelivr.net/npm/sweetalert2@9.14.4/dist/sweetalert2.all.min.js","https://cdn.jsdelivr.net/npm/toastify-js",r+"assets/login/js/front.js"];n=="app"||n=="dashboard"||n=="registro"?(console.log("cssLoadMod-loadStyle",n),Y(s,"appCS-"),pr(a,"appJS-","load")):(console.log("cssLoadMod-delStyle",n),z(s,"appCS-"),pr(a,"appJS-","del"));const e=["https://fonts.googleapis.com/css?family=Playfair+Display:400,700%7CSintony:400,700",r+"assets/tema/css/bootstrap.min.css",r+"assets/tema/css/all.min.css",r+"assets/tema/css/animate.min.css",r+"assets/tema/css/simple-line-icons.min.css",r+"assets/tema/css/owl.carousel.min.css",r+"assets/tema/css/owl.theme.default.min.css",r+"assets/tema/css/magnific-popup.min.css",r+"assets/tema/css/theme.css",r+"assets/tema/css/theme-elements.css",r+"assets/tema/css/theme-blog.css",r+"assets/tema/css/theme-shop.css",r+"assets/tema/css/settings.css",r+"assets/tema/css/layers.css",r+"assets/tema/css/navigation.css",r+"assets/tema/css/demo-business-consulting.css",r+"assets/tema/css/skin-business-consulting.css",r+"assets/tema/css/style.css",r+"assets/font-awesome-4.7.0/css/font-awesome.css"],i=[r+"assets/tema/js/jquery.appear.min.js",r+"assets/tema/js/jquery.easing.min.js",r+"assets/tema/js/jquery.cookie.min.js",r+"assets/tema/js/popper.min.js",r+"assets/tema/js/bootstrap.min.js",r+"assets/tema/js/common.min.js",r+"assets/tema/js/jquery.validate.min.js",r+"assets/tema/js/jquery.easypiechart.min.js",r+"assets/tema/js/jquery.gmap.min.js",r+"assets/tema/js/jquery.lazyload.min.js",r+"assets/tema/js/jquery.isotope.min.js",r+"assets/tema/js/owl.carousel.min.js",r+"assets/tema/js/jquery.magnific-popup.min.js",r+"assets/tema/js/jquery.vide.min.js",r+"assets/tema/js/vivus.min.js",r+"assets/tema/js/theme.js",r+"assets/tema/js/jquery.themepunch.tools.min.js",r+"assets/tema/js/jquery.themepunch.revolution.min.js",r+"assets/tema/js/demo-business-consulting.js",r+"assets/tema/js/custom.js",r+"assets/tema/js/theme.init.js"];n!="Home"?(z(e,"homeCS-"),mr(i,"homeJS-")):(Y(e,"homeCS-"),vr(i,"homeJS-"));const t=["https://fonts.googleapis.com/css?family=Open+Sans:400italic,400,700,300&amp;lang=es",r+"assets/font-awesome-4.7.0/css/font-awesome.css",r+"assets/vcard/css/style2.css",r+"assets/vcard/css/examples.css",r+"assets/vcard/css/webhost.css"],l=["https://maps.google.com/maps/api/js?key=AIzaSyBiB2Ny_sdk1kyc8tVK64NfxQ1b0yQoaWw",r+"assets/vcard/js/gmaps.js"];n!="vcard"?(z(t,"vcardCS-"),mr(l,"vcardJS-")):(Y(t,"vcardCS-"),vr(l,"vcardJS-"))}var Bn={apiKey:"AIzaSyDeX81H_K8AsV2KjQgEbwxte6yVdSYqFXk",authDomain:"vcardapp-js.firebaseapp.com",databaseURL:"https://vcardapp-js.firebaseio.com",projectId:"vcardapp-js",storageBucket:"vcardapp-js.appspot.com",messagingSenderId:"420720513571",appId:"1:420720513571:web:f072eeda6cd3cfa1429796",measurementId:"G-LDPZ4BZ1GV"};const ar=Dr(Bn),er=Ar(ar),wr=Or(ar);Nr(ar);function Hn(n){console.log("saveUser");var r={uid:n.uid,usuario:n.displayName,email:n.email,foto:n.photoURL};Mr(br(wr,"vcard_signup/"+n.uid),r)}function Gn(n){const r=document.querySelector("#photo"),s=document.querySelector("#nombre_session"),a=document.querySelector("#email_session"),e=document.querySelector("#id_code_google"),i=br(wr,"vcard_signup/");$r(i,t=>{const l=t.val();for(let c in l){const o=l[c];if(o.uid==n.uid){console.log(o);const p='<img src="'+(o.foto==null?page_url+"assets/img/sinfoto.png":o.foto)+'" class="img-fluid rounded-circle">',d=o.usuario==null?o.email:o.usuario,L=o.email,h=o.uid;r.innerHTML=p,s.innerHTML=d,a.innerHTML=L,e.innerHTML=h}}})}document.querySelectorAll(".logged-out");document.querySelectorAll(".logged-in");const ur=n=>{console.log("loginCheck"),document.querySelector("#logout-1");const r=document.querySelector("#btnRegis"),s=document.querySelector("#btnLogin"),a=document.querySelector(".registro-page"),e=document.querySelector(".login-page"),i=document.querySelector(".dashboard");n?(e.style.display="none",a.style.display="none",i.style.display="block"):(e.style.display="block",i.style.display="none",r&&r.addEventListener("click",()=>{a.style.display="block",e.style.display="none"}),s&&s.addEventListener("click",()=>{a.style.display="none",e.style.display="block"}))};function Ir(n,r){Toastify({text:n,duration:3e3,destination:"https://github.com/apvarun/toastify-js",newWindow:!0,close:!0,gravity:"bottom",position:"right",stopOnFocus:!0,style:{background:r==="success"?"green":r==="warning"?"orange":r==="info"?"blue":"red"},onClick:function(){}}).showToast()}function Un(){const n=document.querySelector("#googleLogin");n&&n.addEventListener("click",async r=>{r.preventDefault();const s=new Rr;try{const a=await qr(er,s);console.log(a),console.log("google sign in"),localStorage.setItem("Token",a.user.accessToken);let e=localStorage.getItem("Token");consoleLocal("log","Res-Token:"+e),Ir("Welcome "+a.user.displayName,"success")}catch(a){console.log(a)}})}function Fn(){const n=document.querySelector("#logout");n&&n.addEventListener("click",async r=>{r.preventDefault();try{await Cr(er),console.log("Logout/Salir"),localStorage.clear();var s=localStorage.getItem("Token");s==null&&console.warn("TOKEN CLEAR"),Ir("Signup out","info")}catch(a){console.log(a)}})}function Vn(){console.log("Cargando App..."),Un(),Fn(),Er(er,async n=>{if(n){ur(n),Gn(n);try{Hn(n)}catch(r){console.log(r)}}else ur(n)}),_n()}const f=()=>{Vn()},{dominio:Wn}=b();async function gr(n,r){const a=await(await fetch(r)).json();let e=null;for(const i in a)(a[i].profile===n||a[i].ID===n)&&(e=a[i]);return e}function nr(n){n!="inicio"?$("#close").show():$("#close").hide(),n=="inicio"?$("#inicio").fadeIn():$("#inicio").hide(),n=="contacto"?$("#contacto").fadeIn():$("#contacto").hide(),n=="ubicacion"?$("#ubicacion").fadeIn():$("#ubicacion").hide(),n=="compartir"?$("#compartir").fadeIn():$("#compartir").hide(),n=="guardar"?$("#guardar").fadeIn():$("#guardar").hide(),n=="acceso"?$("#acceso").fadeIn():$("#acceso").hide()}function Jn(n){{$("#inputCopiar").select();var r=document.execCommand("copy");r?(console.log("Texto Copiado"),document.getElementById("aviso").innerHTML='<div class="alert alert-success">Texto Copiado!</div>'):console.log("> No copy to clipboard")}}function Yn(){const n=document.querySelector("#footerbar");n&&n.addEventListener("click",r=>{const s=r.target.id.replace("btn","").replace("1","").toLowerCase();s&&s!=""&&nr(s)})}function zn(n,r,s){var a=new Image;a.src=n,a.addEventListener("load",()=>{const e=s==0?"Logo":"Foto de perfil";console.log("(1)Success: "+e),s==0?r.src=n:r.style.backgroundImage=`url('${n}')`}),a.addEventListener("error",()=>{const e=`${Wn}assets/img/sinfoto.png`;s==0?r.src=e:r.style.backgroundImage=`url('${e}')`;const i=s==0?"logo":"foto de perfil";console.warn("(1)Error: Fallo carga de "+i)})}function fr(n,r,s,a){var e=new Image;e.src=n,e.addEventListener("load",()=>{const i=a==0?"Logo":"Foto de perfil";console.log("(2)Success: "+i),a==0?s.src=n:s.style.backgroundImage=`url('${n}')`}),e.addEventListener("error",()=>{const i=a==0?"logo":"foto de perfil";r&&r!=""?zn(r,s,a):console.error("(2)Error: Fallo carga de "+i)})}const{dominio:K,id:Q,URL:Z}=b();async function Kn(){const n=encodeURIComponent(Z);console.log(n);const r=await gr(Q,I+"/vcard_vcard.json");if(console.log("Usuario",r),r==null){document.querySelector("#container").style.display="none";return}const{nombre:s,profile:a,puesto:e,descripcion:i,fb:t,tw:l,ins:c,lk:o,web:v,email:p,cell:d,tel_ofi:L,cover:h,idemp:y,visible:ir,direc:S}=r,k=await gr(y,I+"/vcard_vcard_empresas.json");console.log("Empresa",k);const{bg_color:x,coverbg:_,empresa:P}=k;nr("inicio"),Yn();const w=document.querySelector("#head");w&&(w.style.backgroundColor=x,w.innerHTML=`<img id="logo" src="${K}assets/img/sinlogo.png" onerror="this.src='${K}assets/img/sinlogo.png'" alt="logo">`);const M=Q=="multiportal"?"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpprRNyywxrgFdZ7rLvnq-6jEgWCBq_4Js3A&s":null;fr(k.cover,M,document.querySelector("#logo"),0);const B=Q=="multiportal"?"https://multiportal.webcindario.com/assets/img/Multiportal.logo2023.png":null;fr(h,B,document.querySelector("#fotoperfil"),1),document.querySelector("#tit").innerHTML=s,document.querySelector("#puesto").innerHTML=e,document.querySelector("#des").innerHTML=i;const H=document.querySelector("#medios"),T=d?`<a href="tel:${d}"><i class="fa fa-phone"></i><span>Llamar</span></a>`:"",G=d?`<a target="_blank" href="https://wa.me/+52${d}"><i class="fa fa-whatsapp"></i><span>WhatsApp</span></a>`:"",U=p?`<a href="mailto:${p}"><i class="fa fa-envelope-o"></i><span>E-mail</span></a>`:"",F=v?`<a href="${v}" target="_blank" id="empresaweb">${P}</a>`:"";H.innerHTML=T+G+U+F,document.querySelector("#promo").src=`${K}assets/vcard/img/concepto1.jpg`;const g=document.querySelector("#redes"),u=t?`
  ...
  <a href="${c}" target="_blank" aria-label="Instagram" class="icon-rrss">
    ...
    <span>Instagram</span>
  </a>`:"";g.innerHTML=`<div id="medios">${u} ${V} ${j} ${A}</div>`;const R=document.querySelector("#a-cell");d?R.setAttribute("href","tel:"+d):R.style.display="none";const q=document.querySelector("#a-wa");d?q.setAttribute("href","https://wa.me/+52"+d):q.style.display="none";const C=document.querySelector("#a-sms");d?C.setAttribute("href","sms:"+d):C.style.display="none";const E=document.querySelector("#a-email");p?E.setAttribute("href","mailto:"+p):E.style.display="none";const D=document.querySelector("#a-web");v?D.setAttribute("href",v):D.style.display="none";const tr=document.querySelector("#ubi");tr.innerHTML=S?`<p style="font-size: 18px;"><b>Dirección:</b> ${S}</p>
  ...
  <a target="_blank" href="https://api.whatsapp.com/send?text=Accede+a+la+tarjeta+digital+desde+el+siguiente+enlace:+${n}" aria-label="whatsapp" class="icon-access">
    ...
    <span>WhatsApp</span>
  </a>`;Sr.innerHTML=`${_r}${Pr}${Tr}${jr}`,document.querySelector("#inputCopiar").value=Z;const or=document.querySelector("#viewcopy");or&&or.addEventListener("click",()=>{Jn()}),document.querySelector("#sendEmail").href="mailto:?body="+Z,document.querySelector("#saveCard").href=`files/vcf/${a}.vcf`;const lr=document.querySelector("#close");lr&&lr.addEventListener("click",()=>{nr("inicio")})}function Qn(){setTimeout(()=>{Kn()},500)}function Zn(n){const{route:r,hash:s,mod:a,base_url:e}=n;m("log","route="+r),Tn(),a&&($n(a),Mn(a,e)),r=="dashboard/index"&&f(),r=="registro/index"&&f(),r=="app/index"&&f(),r=="app/perfil"&&f(),r=="app/tarjetas"&&f(),r=="app/empresas"&&f(),(r=="vcard/index"||r=="vcard/profile")&&Qn(),r=="login/index"&&Nn(),r=="logout/index"&&On(),(a=="app"||a=="dashboard")&&An(s,r,a)}function b(){var n=window,r=document,s=n.location,a=new Date,e=a.getDate();e=e<10?"0"+e:e;var i=a.getMonth()+1;i=i<10?"0"+i:i;var t=a.getFullYear(),l=t+"-"+i+"-"+e;const{protocol:c,host:o,origin:v,pathname:p,hash:d,href:L,search:h}=s,y=v+"/",ir=v,S=L,k=h,x=p.replace("/",""),_=y+x,P=o=="localhost"||o!=X&&o!=rr?x+N:N,w=o=="localhost:9001"?"../":"./",M=y+P,B=screen.width,H=screen.height;var T="default",G="temas/"+T+"/",U=hn(),F=yn(d,N);let{mod:g,ext:u,id:V}=kn(p,d);var j="/"+u,A=g+j,R=g||"",q=u&&u!="index"?"/"+u:"",C="#/"+R+q,E=_+W+A+".html",D=_+W+"404/index.html";return{w:n,d:r,loc:s,dt:a,day:e,mon:i,year:t,fecha:l,title:Br,typeBack:Hr,typeDev:Gr,path_hash:N,path_src:hr,path_page:W,hostDev:X,hostPre:rr,protocol:c,host:o,dominio:y,dominio1:ir,pathname:p,hash:d,URL:S,quest:k,path_url:x,path_root:P,path_build:w,base_url:_,page_url:M,screenw:B,screenh:H,tema:T,path_tema:G,pag_name:U,vars_Url:F,mod:g,ext:u,id:V,ext2:j,route:A,hash2:C,url_mod:E,url404:D,apiVer:Fr}}function sr(){const n=b();console.log(n);const{hash:r,mod:s,ext:a,id:e,page_url:i,title:t}=n;wn(r,s,a,e,t),Zn(n),xn(r,s,yr),Sn(s,i),jn()}function Xn(){console.log("Run function inicio"),sr()}window.addEventListener("hashchange",()=>{sr()});document.addEventListener("click",n=>{const{target:r}=n;r.matches("nav li a")&&(n.preventDefault(),Lr())});const Lr=n=>{n=n||window.event,n.preventDefault(),window.history.pushState({},"",n.target.href),sr()};window.route=Lr;Xn();
