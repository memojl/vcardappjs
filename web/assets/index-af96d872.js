...
<!-- ============================================================== -->\r
<!-- End Page content -->\r
<!-- ============================================================== -->`,Le=`<div class="container text-center">\r
    <div class="row">\r
...
</div>`,se={Home:Re},Be={dashboard:'<!-- Begin page --><div id="wrapper">'+J+Y+'<div class="content-page">'+ke+Z+"</div></div><!-- END wrapper -->"+Q,app:'<!-- Begin page --><div id="wrapper" class="dashboard" style="display: none;">'+J+Y+'<div class="content-page">'+Ce+Z+"</div></div><!-- END wrapper -->"+Q+Ie+_e,dash:$e,tarjetas:Me,empresas:Ae,cuenta:Te,settings:Ee,forget:Le,login:qe,logout:je,registro:De,noauth:Pe},ie={...se,...Be},Oe=["dashboard","tarjetas","empresas","cuenta","settings"],ee={dash:{txt:"Dashboard",icon:"fas fa-tachometer-alt"},tarjetas:{txt:"Mis tarjetas",icon:"far fa-address-card"},empresas:{txt:"Mis empresas",icon:"fas fa-industry"}},Ue=`<div class="text-center">\r
