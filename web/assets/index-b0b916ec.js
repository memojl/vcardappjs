(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))e(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&e(i)}).observe(document,{childList:!0,subtree:!0});function r(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function e(a){if(a.ep)return;a.ep=!0;const s=r(a);fetch(a.href,s)}})();let cn=window.location;const{pathname:pn,host:q}=cn;q!=="localhost"&&q!=="127.0.0.1:5173"&&"serviceWorker"in navigator&&navigator.serviceWorker.register(pn+"sw.js").then(function(n){console.log("Service Worker registro correcto con scope: ",n.scope)}).catch(function(n){console.log("Service Worker registro fallo: ",n)});const{host:un}=window.location,gn="VcardApp",y="#/",U="src/",j=U+"pages/",I="127.0.0.1:5173",N="127.0.0.1:4173",F=un!=I?"https://apirestm.webcindario.com/api":"http://localhost/MisSitios/apirestm/api",hn=`<!-- ============================================================== -->\r
...
<!--//LOGIN-->`,bn=`<div class="container text-center">\r
    <h1>Logout</h1>\r
...
<!--//REGISTRO-->`,wn=`<div class="alert alert-warning" role="alert">\r
...
\r
    ...
    \r
        ...
        <!-- end Topbar -->`,v=`              <!-- Footer Start -->\r
            ...
            <!-- end Footer -->`,Cn=`<div class="body">\r
...
</div>`,z={Home:Cn},Ln={dashboard:'<!-- Begin page --><div id="wrapper">'+m+h+'<div class="content-page">'+hn+v+"<div></div><!-- END wrapper -->"+g,settings:'<!-- Begin page --><div id="wrapper">'+m+h+'<div class="content-page">'+mn+v+"</div></div><!-- END wrapper -->"+g,cuenta:'<!-- Begin page --><div id="wrapper">'+m+h+'<div class="content-page">'+xn+v+"<div></div><!-- END wrapper -->"+g,empresas:'<!-- Begin page --><div id="wrapper">'+m+h+'<div class="content-page">'+kn+v+"</div></div><!-- END wrapper -->"+g,tarjetas:'<!-- Begin page --><div id="wrapper">'+m+h+'<div class="content-page">'+Sn+v+"<div></div><!-- END wrapper -->"+g,forget:vn,login:fn,logout:bn,registro:yn,noauth:wn},V={...z,...Ln},jn=["dashboard","settings"],En=`<div class="text-center">\r
