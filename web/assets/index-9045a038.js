(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))e(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&e(i)}).observe(document,{childList:!0,subtree:!0});function r(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function e(a){if(a.ep)return;a.ep=!0;const s=r(a);fetch(a.href,s)}})();let ln=window.location;const{pathname:dn,host:M}=ln;M!=="localhost"&&M!=="127.0.0.1:5173"&&"serviceWorker"in navigator&&navigator.serviceWorker.register(dn+"sw.js").then(function(n){console.log("Service Worker registro correcto con scope: ",n.scope)}).catch(function(n){console.log("Service Worker registro fallo: ",n)});const{host:cn}=window.location,pn="VcardApp",y="#/",B="src/",j=B+"pages/",U="127.0.0.1:5173",un="127.0.0.1:4173",H=cn!=U?"https://apirestm.webcindario.com/api":"http://localhost/MisSitios/apirestm/api",gn=`<!-- ============================================================== -->\r
...
\r
            ...
            <!-- Left Sidebar End -->`,v=`          <!-- Topbar Start -->\r
...
</div>`,F={Home:Sn},Cn={dashboard:'<!-- Begin page --><div id="wrapper">'+v+h+'<div class="content-page">'+gn+m+"<div></div><!-- END wrapper -->"+g,settings:'<!-- Begin page --><div id="wrapper">'+v+h+'<div class="content-page">'+hn+m+"</div></div><!-- END wrapper -->"+g,cuenta:'<!-- Begin page --><div id="wrapper">'+v+h+'<div class="content-page">'+wn+m+"<div></div><!-- END wrapper -->"+g,empresas:'<!-- Begin page --><div id="wrapper">'+v+h+'<div class="content-page">'+xn+m+"</div></div><!-- END wrapper -->"+g,tarjetas:'<!-- Begin page --><div id="wrapper">'+v+h+'<div class="content-page">'+kn+m+"<div></div><!-- END wrapper -->"+g,forget:vn,login:mn,logout:fn,registro:bn,noauth:yn},z={...F,...Cn},Ln=["dashboard","settings"],jn=`<div class="text-center">\r
