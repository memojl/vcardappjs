...
</div>`,ee={Home:De},Pe={dashboard:'<!-- Begin page --><div id="wrapper">'+K+W+'<div class="content-page">'+ye+X+"</div></div><!-- END wrapper -->"+G,app:'<!-- Begin page --><div id="wrapper" class="dashboard" style="display: none;">'+K+W+'<div class="content-page">'+we+X+"</div></div><!-- END wrapper -->"+G+xe+ke,tarjetas:qe,empresas:je,cuenta:Ee,settings:Se,forget:Ce,login:$e,logout:Ie,registro:_e,noauth:Le},te={...ee,...Pe},Te=["dashboard","tarjetas","empresas","cuenta","settings"],Ae=`<div class="text-center">\r
